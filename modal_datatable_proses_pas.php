<div class="modal fade" id="modal_prosp1"  role="dialog" tabindex="-1">
				...
				<td>
					<div class="dropdown">
					  ...
					  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						...
						tgl_fal_datetime="<?php echo $row['tgl_fal_datetime'];?>"
						lain_lain="<?php echo $row['lain_lain'];?>"
						class="dropdown-item respro">Reschedule</a><a name="edit" data-id="<?php echo $row['username_fal'];?>"
						username_fal="<?php echo $row['username_fal'];?>"
						key_fal="<?php echo $row['key_fal'];?>"
						pic_ikr="<?php echo $row['pic_ikr'];?>"
						jenis_wo="<?php echo $row['jenis_wo'];?>"
	...
	<div class="modal fade" id="modal_prosp2"  role="dialog" tabindex="-1">
	...
	<div class="modal fade" id="modal_prosp3"  role="dialog" tabindex="-1">
	...
	<div class="modal fade" id="modal_prosp4"  role="dialog" tabindex="-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                 ...
                 <div class="modal-body">
					...
					<div class="card shadow mb-4">
				<div class="card-header py-3">
				  <h6 class="m-0 font-weight-bold text-primary">List Working Order4</h6>
				</div>
				<div class="card-body">
				  <div class="table-responsive">
					<table class="table table-bordered" id="tabel_ikr" width="100%" cellspacing="0">
	...
	<div class="modal fade" id="modal_prosp5"  role="dialog" tabindex="-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                 ...
                 <div class="modal-body">
					...
					<div class="card shadow mb-4">
				<div class="card-header py-3">
				  <h6 class="m-0 font-weight-bold text-primary">List Working Order5</h6>
				</div>
				<div class="card-body">
				  <div class="table-responsive">
					<table class="table table-bordered" id="tabel_ikr" width="100%" cellspacing="0">
	...
	<div class="modal fade" id="modal_prosp6"  role="dialog" tabindex="-1">
