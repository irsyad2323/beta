<div class="modal fade" id="modal_sign_unified" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-user">List Working Belum Diambil</h4>
...
$(document).ready(function() {
    $('#time_slot_filter').change(function() {
        loadTimeSlotData($(this).val());
    });
    
    // Load default data
    loadTimeSlotData('06:00:00-07:59:59');
});

function loadTimeSlotData(timeSlot) {
    $('#data_container').html('<div class="text-center"><i class="fa fa-spinner fa-spin"></i> Loading...</div>');
    ...
    $.ajax({
        ...
        error: function() {
            $('#data_container').html('<div class="alert alert-danger">Error loading data</div>');
        }
    });
}
</script>