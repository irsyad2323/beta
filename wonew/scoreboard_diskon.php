...
<html lang="en">
    ...
    <body class="nav-fixed">
        <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
            ...
            <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="#">ScoreBoard Naratel</a>
            <!-- Navbar Search Input-->
                    ...
                    <div class="container-xll px-4 mt-n10">
                        <div class="row">
                            <div class="col-xxl-6 col-xl-12 mb-4">
                                <div class="card mb-2">
														<div class="card-header">Diskon Biaya Instalasi</div>
														<div class="card-body">
															<div class="table-responsive">
															<table class="table table-bordered" id="diskon_instalasi" width="100%" cellspacing="0">
																<thead>
																<tr>				 
																  <th>No.</th>
																  <th>PIC</th>
                            ...
                            <div class="col-xxl-6 col-xl-12 mb-4">
                                <div class="card mb-2">
														<div class="card-header">Fasilitas Gratis</div>
														<div class="card-body">
															<div class="table-responsive">
															<table class="table table-bordered" id="fasilitas_gratis" width="100%" cellspacing="0">
																<thead>
																<tr>				 
																  <th>No.</th>
																  <th>PIC</th>
    ...
    var table = $('#diskon_instalasi').DataTable({
				"responsive": true,
                "processing": true,
                "ajax": {
							"url": "model/list_count_unit_diskon.php", // Path menuju skrip PHP
							"type": "POST",
                ...
                "paging": true,
                "lengthChange": true,
				"pageLength": 4,  // Menambahkan ini untuk mengatur jumlah entri per halaman
                "searching": true,
                "ordering": false,
                "info": false,
                "autoWidth": true,			
				"columns": [
					{ "data": "urutan" },
					{ "data": "kd_layanan" },
					{ "data": "diskon_biaya_instalasi" },
					{ "data": "formatted_nominal" }
				]
    });
		
    var table = $('#fasilitas_gratis').DataTable({
				"responsive": true,
                "processing": true,
                "ajax": {
							"url": "model/list_count_unit_free.php", // Path menuju skrip PHP
							"type": "POST",
							/* "data": {"data_customer": "<?= $x['kelas_key'];?>"} */ // Buka komentar jika diperlukan
						},
      ...
      $.ajax(
      {
        ...
        {        		
		  ...
		  function ShowGrpah(data) {
				...
				$('#diskon_instalasi').DataTable().clear().destroy();
				var table = $('#diskon_instalasi').DataTable({
				"responsive": true,
                "processing": true,
                "ajax": {
							"url": "model/list_count_unit_diskon.php", // Path menuju skrip PHP
							"type": "POST",
							"data": data// Buka komentar jika diperlukan
						},
				...
				$('#fasilitas_gratis').DataTable().clear().destroy();
				var table = $('#fasilitas_gratis').DataTable({
				"responsive": true,
                "processing": true,
                "ajax": {
