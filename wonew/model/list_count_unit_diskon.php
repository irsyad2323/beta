...
$sql_count = "SELECT kd_layanan ,COUNT(kd_layanan) as diskon_biaya_instalasi, CONCAT('Rp ', FORMAT(SUM(total_diskon), 0)) AS formatted_nominal FROM tbl_fal WHERE perlakuan = 'Diskon Biaya Instalasi' and tgl_ins_datetime BETWEEN '".$awal." 00:00:00' AND '".$akhir." 23:59:59' GROUP BY kd_layanan;";
