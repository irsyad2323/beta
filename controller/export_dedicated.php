<?php
  ...
  $query = "SELECT * FROM tbl_fal WHERE produk='Dedicated' and jenis_wo='INSTALASI_DEDICATED' and YEAR(tanggal_instalasi)= '2022' or '2023' ORDER BY tanggal_instalasi DESC ";
  ...
  header('Content-Disposition: attachment;filename="Intalasi_dedicated.xlsx"');
