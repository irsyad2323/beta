<?php
  ...
  $sheet->setCellValue('Z1', 'Username Maintenance');
   


  // menampilkan data users
  $query = "SELECT * FROM tbl_fal where YEAR(tanggal_instalasi)='2023' ORDER BY tanggal_instalasi DESC ";
  ...
  if($statement->rowCount() > 0) {
      ...
      $sheet->setCellValue('Z'.$i , $row['username_Maintenance']);
  ...
  header('Content-Disposition: attachment;filename="all_wo.xlsx"');
