            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">View Jenis Pembayaran  </br> Verified </br> Pasuruan <?php //echo $_SESSION["level_user"]; ?></h1>
         ...
         $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"models/datapengguna_ikr_keuangan_pas_verified.php",
