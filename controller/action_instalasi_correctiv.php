...
//       }
      ...
      /* $query="INSERT INTO tbl_fal VALUES ('','$nama','$alamat','$telepon','$paket_fal','$tgl_fal','$username_fal','$password_fal','$lain_lain','$kd_layananan','$latitude','$latitude','$longitude')"; */
       $query="INSERT INTO tbl_fal_correctiv (nama_fal, alamat_fal, tlp_fal, paket_fal, tgl_fal, username_fal, password_fal, lain_lain, kd_layanan, pic_ikr, kelurahan, rt, rw, jenis_wo, produk, total_modem, verified, pembayaran) 
			   VALUES ('$nama_fal','$alamat_fal','$tlp_fal','$paket_fal','$tgl_fal','$username_fal[0]','$password_fal','$lain_lain','$kd_layanan','$pic_ikr','$kelurahan','$rt','$rw','INSTALASI_CORRECTIV','$produk','$total_modem', 'not_verified', '$pembayaran')";
	}
	if($action == "edit")
	{
      ...
      $query = "UPDATE tbl_fal_correctiv SET username_fal='$username_fal', nama_fal='$nama_fal', alamat_fal='$alamat_fal', tgl_fal='$tgl_fal',tlp_fal='$tlp_fal', pic='$pic', pic2='$pic2',status='$status', status2='$status2', modem='$modem',kabel1='$kabel1',paket_fal='$paket_fal', pic_ikr='$pic_ikr',
      password_fal='$password_fal',pembayaran='$pembayaran', tanggal_instalasi= CURRENT_TIMESTAMP(),lain_lain='$lain_lain', total_modem='$total_modem', status_wo='$status_wo',ket='$ket', latitude='$latitude', longitude='$longitude' ,produk='$produk' WHERE username_fal='$username_fal'";
