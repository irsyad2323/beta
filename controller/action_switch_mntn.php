...
/*   if (isset($_POST['username_sinden'])){
 ...
 $query1 = mysqli_query($koneksi,"UPDATE tbl_maintenance SET pic_ikr='$pic_ikr' WHERE key_fal='$key_fal_switch';");
 $query2 = mysqli_query($koneksi,"INSERT INTO tbl_log_switch_mntn (username, pic_ikr, pic_ikrswitch, date_time) values ('$username_log','$pic_ikr','$pic_ikrswitch',CURRENT_TIMESTAMP());");
