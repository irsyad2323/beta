...
/*   if (isset($_POST['username_sinden'])){
  ...
  $nama_fal_s= $_POST['nama'];
   function clean($string){
		$string = str_replace(' ', ' ', $string); // Replaces all spaces with hyphens.
		return preg_replace('/[^A-Za-z0-9\-]/', ' ', $string); // Removes special chars.
	}
	
   $nama_jadi = clean($nama_fal_s);
   $id=$_POST['id'];
...
$sql = "INSERT INTO tbl_maintenance_patroli (nama,id_jenis, alamat, tgl, keterangan, kd_layanan, pic_ikr, jenis_wo, tgl_date_time, admin_ts) 
	   VALUES ('$nama_jadi','$id','$alamat',CURRENT_TIMESTAMP(),'$keterangan','$kd_layanan','$pic_ikr','$jenis_pekerjaan',CURRENT_TIMESTAMP(), '".$_SESSION["username"]."')";
...
Jenis Pekerjaan :  Patroli jaringan
