...
//       }
      ...
      /* $query="INSERT INTO tbl_fal VALUES ('','$nama','$alamat','$telepon','$paket_fal','$tgl_fal','$username_fal','$password_fal','$lain_lain','$kd_layananan','$latitude','$latitude','$longitude')"; */
       $query="INSERT INTO tbl_maintenance (nama_fal, alamat_fal, tlp_fal, username_fal, lain_lain, kd_layanan, pic_ikr, kelurahan, rt, rw, jenis_wo, produk, username_Maintenance, tgl_date_time) VALUES ('$nama_fal','$alamat_fal','$tlp_fal',CURRENT_TIMESTAMP(),'$lain_lain','$kd_layanan','$pic_ikr','$kelurahan','$rt','$rw','MAINTENANCE','$produk','$username_Maintenance',CURRENT_TIMESTAMP())";
	}
	if($action == "edit")
	{
      ...
      $query = "UPDATE tbl_maintenance SET username_Maintenance='$username_Maintenance', nama_fal='$nama_fal', alamat_fal='$alamat_fal', tlp_fal='$tlp_fal', pic='$pic', pic2='$pic2',status='$status', status2='$status2', modem='$modem',kabel1='$kabel1',kabel2='$kabel2',kabel3='$kabel3',kategori_maintenance='$kategori_maintenance', pic_ikr='$pic_ikr', tanggal_instalasi= CURRENT_TIMESTAMP(),lain_lain='$lain_lain',  status_wo='$status_wo',ket='$ket', latitude='$latitude', longitude='$longitude' ,produk='$produk', jenis_pekerjaan='$jenis_pekerjaan' WHERE username_fal='$username_fal'";
