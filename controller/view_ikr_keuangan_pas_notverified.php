        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <hr class="sidebar-divider my-0">	
				...
				<?php 
                            ...
                            if ( $_SESSION["level_user"] != "adminwo_fulus" ){ 
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ikr_kapten.php">Kapten Naratel</a>
						
						<a class="collapse-item" href="view_kapten_correctiv.php">Instalasi Corective</a>

                        <a class="collapse-item" href="ikr_sinden.php">Sinden</a>

                        <a class="collapse-item" href="ikr_omahwifi.php">Omah Wifi</a>

                        <a class="collapse-item" href="ikr_broadband.php">Broadband</a>

                        <a class="collapse-item" href="ikr_dedicated.php">Dedicated</a>
             ...
             <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="maintenanceodp.php">Maintenance ODP</a>

                        <a class="collapse-item" href="view_gamas.php">View GAMAS</a>                        
			 ...
			 <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilitiesodp"

                    aria-expanded="true" aria-controls="collapseUtilitiesodp">
                ...
                <div id="collapseUtilitiesodp" class="collapse" aria-labelledby="headingUtilities"

                    data-parent="#accordionSidebar">

                    <div class="bg-white py-2 collapse-inner rounded">
						
                        <h6 class="collapse-header">ODP:</h6>

                        <a class="collapse-item" href="odp.php">Instalasi ODP</a>
						
						<?php 

            if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "adminwo_fulus" && $_SESSION["level_user"] != "ts" ){ 

                        ?>
						
						<a class="collapse-item" href="odp_edit.php">Edit Data ODP</a>
           ...
           <li class="nav-item active">               
				...
				<a class="nav-link" href="report_nmc.php">
                ...
                <a class="nav-link" href="dismantle.php">
			...
			<li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="keuangan_mlg_read_ver.php">Malang</a>

                        <a class="collapse-item" href="keuangan_pas_read_ver.php">Pasuruan</a>                        
            ...
            if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "ts" ){ 
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="view_ikr_keuangan_notverified.php">Not Verified </a>

                        <a class="collapse-item" href="view_ikr_keuangan_verified.php">Verified</a>                        
				...
				<div id="collapsePages" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="view_ikrcorrectiv_keuangan_notverified.php">Not Verified </a>
						<a class="collapse-item" href="view_ikrcorrectiv_keuangan_verified.php">Verified </a> 
				...
				<?php 
				 ...
				 <div id="collapsePages" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <h6 class="collapse-header">PASURUAN: </h6>

                        <a class="collapse-item" href="view_ikr_keuangan_pas_notverified.php">Not Verified</a>

                        <a class="collapse-item" href="view_ikr_keuangan_pas_verified.php">Verified</a>                        
				...
				<div id="collapsePages" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="view_ikrcorrectiv_keuanganpas_notverified.php">Not Verified </a>
						<a class="collapse-item" href="view_ikrcorrectiv_keuanganpas_verified.php">Verified </a> 
			...
			<li class="nav-item">
                ...
                <div id="collapseUtilities3" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="view_user.php">Pelanggan</a>

                        <a class="collapse-item" href="view_user_odp.php">ODP</a>                        
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">View Jenis Pembayaran </br> Not Verified </br> Pasuruan <?php //echo $_SESSION["level_user"]; ?></h1>
         ...
         $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"models/datapengguna_ikr_keuangan_pas_notverified.php",
                ...
                "columns": [
					...
					{ mData: 'harga',  render: $.fn.dataTable.render.number( ',', '.', 2, 'Rp. ' )} ,
