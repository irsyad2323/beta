<?php
  ...
  require_once '../asset/PHPExceltes/PHPExcel.php';
  ...
  $query = "SELECT * FROM tbl_fal WHERE produk='Sinden' and YEAR(tanggal_instalasi)='2022' and jenis_wo='INSTALASI_SINDEN' ORDER BY tanggal_instalasi DESC ";
  ...
  if($statement->rowCount() > 0) {
	  ...
	  $sheet->setCellValue('C'.$i , PHPExcel_Shared_Date::PHPToExcel( '2014-10-16' ));
  ...
  header('Content-Disposition: attachment;filename="Intalasi_sinden.xlsx"');
