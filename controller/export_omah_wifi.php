<?php
  ...
  $query = "SELECT * FROM tbl_fal WHERE produk='Omah Wifi' and YEAR(tanggal_instalasi)='2022' and jenis_wo='INSTALASI_OMAH_WIFI' ORDER BY tanggal_instalasi DESC ";
  ...
  header('Content-Disposition: attachment;filename="Intalasi_omah_wifi.xlsx"');
