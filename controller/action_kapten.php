...
include('controller.php');
   ...
   if($action == "insert")
	...
	if($action == "edit")
	{
		$query = "UPDATE tbl_fal SET nama_fal='$nama_fal', jenis_pekerjaan='$jenis_pekerjaan', alamat_fal='$alamat_fal', tgl_fal='$tgl_fal',tlp_fal='$tlp_fal', pic='$pic', pic2='$pic2',status='$status', status2='$status2', modem='$modem',kabel1='$kabel1',kabel2='$kabel2',kabel3='$kabel3',paket_fal='$paket_fal', pic_ikr='$pic_ikr',
