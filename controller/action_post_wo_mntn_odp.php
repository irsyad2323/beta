...
if( $kota == 'mlg'){
	...
	if($time == '06:00:00'){
			...
			if($tot_wo_jm6 < $hasil1 ){
				// Insert some values
				$query1 = mysqli_query($koneksi,"INSERT INTO tbl_maintenance (nama_fal, alamat_fal, tlp_fal, tgl_fal, tgl_date_time, username_fal, lain_lain, kd_layanan, pic_ikr, kelurahan, jenis_wo, produk, username_Maintenance) 
				VALUES ('$nama_kom','$alamat','$tlp_kom',CURRENT_DATE(),'$tgl','$id','$keterangan_solving','$kd_kom','-','$kelurahan','MAINTENANCE','$jenis_produk','$id_user');");
				$query2 = mysqli_query($koneksi,"UPDATE keluhan SET status='Visit',handle_kompline='$handle_kompline', kategori_solving ='$kategori_solving' ,keterangan_solving='$keterangan_solving',ktg_ind_mslh='$ktg_ind_mslh' WHERE id='$id';");
