...
// Turn autocommit off
		...
		// Insert some values
		$query1 = mysqli_query($koneksi,"UPDATE tbl_maintenance SET pic_ikr = '".$_SESSION["username"]."', status_wo = 'Proses Pengerjaan' , tgl_proses_teknis= CURRENT_TIMESTAMP(), lokasi_proses='$lok_hasil' WHERE key_fal='$key_fal';");
