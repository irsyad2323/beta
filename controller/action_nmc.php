...
//       }
      ...
      /* $query="INSERT INTO tbl_fal VALUES ('','$nama','$alamat','$telepon','$paket_fal','$tgl_fal','$username_fal','$password_fal','$lain_lain','$kd_layananan','$latitude','$latitude','$longitude')"; */
       $query="INSERT INTO tbl_report_nmc (tanggal_instalasi, lain_lain, kd_layanan, pic_ikr, username_fal, jenis_wo, produk, username_Maintenance, status_wo) VALUES (CURRENT_TIMESTAMP(),'$lain_lain','$kd_layanan','$pic_ikr',CURRENT_TIMESTAMP(),'REPORT_NMC','$produk','$username_Maintenance','$status_wo')";
	}
	if($action == "edit")
	{
      ...
      $query = "UPDATE tbl_report_nmc SET nama_fal='$nama_fal', alamat_fal='$alamat_fal', tgl_fal='$tgl_fal',tlp_fal='$tlp_fal', pic='$pic', pic2='$pic2',status='$status', status2='$status2', modem='$modem',kabel1='$kabel1',kategori_maintenance='$kategori_maintenance',paket_fal='$paket_fal', pic_ikr='$pic_ikr',
      password_fal='$password_fal', tanggal_instalasi= CURRENT_TIMESTAMP(),lain_lain='$lain_lain',  status_wo='$status_wo',ket='$ket', username_Maintenance='$username_Maintenance',ket='$ket' WHERE username_fal='$username_fal'";
