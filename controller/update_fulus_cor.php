...
$sql = "UPDATE tbl_fal_correctiv SET verified='$verified', total_diskon='$total_diskon', angsuran1='$angsuran1', angsuran2='$angsuran2', status_angsuran='$status_angsuran', paket_fal='$paket_fal', verif1='$verif1', verif2='$verif2', pembayaran='$pembayaran', ket_fulus='$keterangan', log_user_verified='".$_SESSION['username']."', tgl_verified=CURRENT_TIMESTAMP() WHERE key_fal='$key_fal';";
