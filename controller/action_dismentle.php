...
//       }
      ...
      /* $query="INSERT INTO tbl_fal VALUES ('','$nama','$alamat','$telepon','$paket_fal','$tgl_fal','$username_fal','$password_fal','$lain_lain','$kd_layananan','$latitude','$latitude','$longitude')"; */
       $query="INSERT INTO tbl_disable (nama_fal, alamat_fal, tlp_fal, paket_fal, tgl_fal, username_fal, password_fal, lain_lain, kd_layanan, pic_ikr, kelurahan, rt, rw, jenis_wo, foto_dpn_rmh, produk, username_Maintenance) VALUES ('$nama_fal','$alamat_fal','$tlp_fal','$paket_fal','$tgl_fal',CURRENT_TIMESTAMP(),'$password_fal','$lain_lain','$kd_layanan','$pic_ikr','$kelurahan','$rt','$rw','DISMANTLE','$foto_dpn_rmh','$produk','$username_Maintenance')";
	}
	if($action == "edit")
	{
      ...
      $query = "UPDATE tbl_disable SET nama_fal='$nama_fal', alamat_fal='$alamat_fal', tgl_fal='$tgl_fal',tlp_fal='$tlp_fal', pic='$pic', pic2='$pic2',status='$status', status2='$status2', modem='$modem',kabel1='$kabel1',kategori_maintenance='$kategori_maintenance',paket_fal='$paket_fal', pic_ikr='$pic_ikr',
      password_fal='$password_fal', tanggal_instalasi= CURRENT_TIMESTAMP(),lain_lain='$lain_lain',  status_wo='$status_wo',ket='$ket', latitude='$latitude', longitude='$longitude' WHERE username_fal='$username_fal'";
