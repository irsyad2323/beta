...
/*   if (isset($_POST['username_sinden'])){
  ...
  $kd_layanan_mntbckbn= $_POST['kd_layanan_mntbckbn'];
   $nama_mntbcbon=$_POST['nama_mntbcbon'];;
   $alamat_mntbckbn = $_POST['alamat_mntbckbn'];
   $kelurahan_mntbckbn=$_POST['kelurahan_mntbckbn'];
   $lain_lain_mntnbckbn=$_POST['lain_lain_mntnbckbn']; 
	...
	mysqli_autocommit($koneksi,FALSE);
		...
		if($time == '06:00:00'){
			...
			if($tot_wo_jm6 < $hasil1 ){
				// Insert some values
				$query1 = mysqli_query($koneksi,"INSERT INTO tbl_backbone (nama_backbone,alamat_fal_backbone, tgl_sign, lain_lain_backbone, kd_layanan_backbone, pic_ikr_backbone, kelurahan) 
				VALUES ('$nama_mntbcbon','$alamat_mntbckbn', '$tgl','$lain_lain_mntnbckbn','$kd_layanan_mntbckbn','-','$kelurahan_mntbckbn');");				
			}else{
				echo "jam1"; die();
			}
		...
		if($tot_wo_jm10 < $hasil ){
			// Insert some values
			//echo "mantab"; die();
			$query1 = mysqli_query($koneksi,"INSERT INTO tbl_backbone (pic_sign,nama_backbone,alamat_fal_backbone, tgl_sign, lain_lain_backbone, kd_layanan_backbone, pic_ikr_backbone, kelurahan) 
				VALUES ('".$acces_user_log."','$nama_mntbcbon','$alamat_mntbckbn', '$tgl','$lain_lain_mntnbckbn','$kd_layanan_mntbckbn','-','$kelurahan_mntbckbn');");
		}else{
			echo "jam3"; die();
		}
