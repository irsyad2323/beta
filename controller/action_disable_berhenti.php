...
//       }
      ...
      /* $query="INSERT INTO tbl_fal VALUES ('','$nama','$alamat','$telepon','$paket_fal','$tgl_fal','$username_fal','$password_fal','$lain_lain','$kd_layananan','$latitude','$latitude','$longitude')"; */
	   ...
	   VALUES ('$nama_fal','$alamat_fal','$tlp_fal','$username_fal','$lain_lain','$kd_layanan','$pic_ikr', '$kategori_pelanggan', '$off_tgl','$off_total', CURRENT_TIMESTAMP(),'$status_log')";
		//echo$query;
	}
	if($action == "edit")
	{
      ...
      lain_lain='$lain_lain', kategori_pelanggan='$kategori_pelanggan', off_total='$off_total', off_tgl='$off_tgl' WHERE username_fal='$username_fal'";
