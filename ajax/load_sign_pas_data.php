...
FROM (
    ...
    FROM tbl_odp b 
    WHERE b.status_wo IN ('Belum Terpasang') 
    AND TIME(b.tgl_sign) BETWEEN '$start_time' AND '$end_time' 
    AND DATE(b.tgl_sign) = DATE('$tanggal_hari_ini') 
    AND b.kd_layanan IN ('pas','pas1')
    ...
    AND TIME(b.tgl_sign) BETWEEN '$start_time' AND '$end_time' 
    AND DATE(b.tgl_sign) = DATE('$tanggal_hari_ini') 
    AND b.kd_layanan_backbone IN ('pas','pas1')
...
<div class="alert alert-info">Debug: Time Slot: <?= $time_slot ?>, Tanggal: <?= $tanggal_hari_ini ?>, Rows Found: <?= $row_count ?></div>
    ...
    <table class="table table-bordered" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($table)) { 
                ...
                $unit_badge = 'badge-danger">SBM</small>';
