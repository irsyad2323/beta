						  ...
						  <div class="card shadow mb-4">
							...
							<div class="card-body">
							  <div class="table-responsive">
								<table class="table table-bordered" id="tabel_visit_pas" width="100%" cellspacing="0">
								  <thead>
									<tr>
										<th>No</th>
										<th>TANGGAL</th>
								  ...
								  <tbody> 
									<?php 
										...
										$table = mysqli_query($koneksi,"SELECT * FROM keluhan WHERE status = 'Visit' and kd_kom='pas' and stts_post = 'n' ORDER BY id DESC");
