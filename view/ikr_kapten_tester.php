                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
						  ...
						  <div class="card shadow mb-4">
							...
							<div class="card-body">
							  <div class="table-responsive">
								<table class="table table-bordered" id="tabel_pengguna_dashtek" width="100%" cellspacing="0">
								  <thead>
									<tr>
									<th>NO</th>
									<th>PIC</th>
						...
						$acces_user_log = $_SESSION["username"];
						  $table = mysqli_query($koneksi,"SELECT
																pic_ikr as user_pic,
																SUM(tot_ikr_bel + tot_mntn_bel + tot_mtnodp_bel) AS on_progres,
																SUM(tot_ikr + tot_mntn + tot_mntn_odp) AS sudah_terpasang
															FROM (
																SELECT pic_ikr ,COUNT(*) AS tot_ikr, 0 AS tot_mntn, 0 as tot_mntn_odp, 0 as tot_ikr_bel, 0 as tot_mntn_bel, 0 as tot_mtnodp_bel
																FROM tbl_fal 
																WHERE status_wo='Sudah Terpasang' and YEAR(tgl_fal_datetime) = '2024' and MONTH(tgl_fal_datetime) = '02' and DAY(tgl_fal_datetime) = '20' GROUP BY pic_ikr

																UNION ALL

																SELECT pic_ikr AS pic_ikr, 0 AS tot_ikr, COUNT(*) as tot_mntn, 0 as tot_mntn_odp, 0 as tot_ikr_bel, 0 as tot_mntn_bel, 0 as tot_mtnodp_bel
																FROM tbl_maintenance 
																WHERE status_wo='Sudah Terpasang' and YEAR(tgl_date_time) = '2024' and MONTH(tgl_date_time) = '04' and DAY(tgl_date_time) = '20'  GROUP BY pic_ikr

																UNION ALL

																SELECT pic_ikr AS pic_ikr, 0 AS tot_ikr, 0 AS tot_mntn, COUNT(*) as tot_mntn_odp, 0 as tot_ikr_bel, 0 as tot_mntn_bel, 0 as tot_mtnodp_bel
																FROM tbl_maintenance_odp 
																WHERE status_wo='Sudah Terpasang' and YEAR(username_fal) = '2024' and MONTH(username_fal) = '04' and DAY(username_fal) = '20'  GROUP BY pic_ikr

																UNION ALL

																SELECT pic_ikr AS pic_ikr, 0 AS tot_ikr, 0 AS tot_mntn, 0 as tot_mntn_odp, COUNT(*) as tot_ikr_bel, 0 as tot_mntn_bel, 0 as tot_mtnodp_bel
																FROM tbl_fal 
																WHERE status_wo='Proses Pengerjaan' GROUP BY pic_ikr
																	
																	UNION ALL

																SELECT pic_ikr AS pic_ikr, 0 AS tot_ikr, COUNT(*) as tot_mntn, 0 as tot_mntn_odp, 0 as tot_ikr_bel, COUNT(*) as tot_mntn_bel, 0 as tot_mtnodp_bel
																FROM tbl_maintenance 
																WHERE status_wo='Proses Pengerjaan' GROUP BY pic_ikr

																	UNION ALL

																SELECT pic_ikr AS pic_ikr, 0 AS tot_ikr, 0 AS tot_mntn, COUNT(*) as tot_mntn_odp, 0 as tot_ikr_bel, 0 as tot_mntn_bel, COUNT(*) as tot_mtnodp_bel
																FROM tbl_maintenance_odp 
																WHERE status_wo='Proses Pengerjaan' GROUP BY pic_ikr
															) AS combined_logs
															GROUP BY pic_ikr ASC");
																				  while ($row = mysqli_fetch_assoc($table)){ 
																				  $i=0;
																				  $no=1;
																				  ?>
						  <tr id=<?php echo $row['user_pic']; ?>">
							<td> <?php echo $no; ?></td>
							<td data-target="user_pic"> <?php echo $row['user_pic'];?></td>
							<td data-target="on_progres"> <?php echo $row['on_progres'];?></td>
							<td data-target="sudah_terpasang"> <?php echo $row['sudah_terpasang'];?></td>
						  </tr>
						  <?php	
						  }
						  ?>
								  ...
								  <tbody> 
									<?php 
										...
										$acces_user_log = $_SESSION["username"];
										  ...
										  WHERE kd_layanan like '".$kota."' and status_wo in ('Belum Terpasang','Proses Pengerjaan') 
										  ...
										  <tr id=<?php echo $row['key_fal']; ?>">
											...
											<td data-target="tgl_fal"> <?php echo $row['tgl_fal_datetime'];?></td>
											<td data-target="tgl_proses_teknis"> <?php echo $row['tgl_proses_teknis'];?></td>
					...
					<?php 
                       ...
                       ?>
						...
						<br/>
							<div class="form-row">
								<label for="rang">Keterangan</label>
								<input class="form-control" type="text" id="keterangan_new" name="keterangan_new" autocomplete="off">
							</div>
						<br/>
                 ...
                 <div class="modal-body">
					...
					<?php 
                       ...
                       ?>
						...
						<br/>
							<input class="form-control" type="hidden" id="pic_ikrswitch" name="pic_ikrswitch" autocomplete="off" disabled>
                            <div class="form-row">
                                <label for="rang">Pic IKR</label>                
...
/* $(document).ready(function() {
    ...
    <script>
            ...
            var username_s = $("#username_s").val();	
			 ...
			 var value = { 
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_switch.php",
                    data: value,
                    success : function(data) {
					//alert(data);
					Swal.fire(
		...
		$(document).on('click', '.actionrespro', function(){
            ...
            var keterangan_new = $("#keterangan_new").val();	
			 
			 //alert(username_s); return;
			 
			 var value = { 
						  username_rescedule:username_rescedule,
						  keterangan_new:keterangan_new,
						 }; 
