...
<div class="modal fade" id="modalpros" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
        ...
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-content">
                 ...
                 <div class="modal-body">
				  ...
				  <div class="form-group col-md-4" id="stor">
                    <label for="rang">Storan</label>                
	...
	$(function() {
	$('#stor').hide();		
    $('#pembayaran_corporate').change(function(){
		var a = $('#pembayaran_corporate').val();
		//alert(a);
       if(a == 'Tunai'){
            $('#stor').show(); 
        }else{
    ...
    <script>
		...
		$(document).on('click', '.save_corporate', function(){
			...
			if(pembayaran_corporate == '-' ){
					...
					return
			}else if(pembayaran_corporate == 'Tunai' ){
				if(storan == '' ){
					Swal.fire({
					  icon: 'error',
					  title: 'Oops...',
					  text: 'storan Belum Terisi!',	
					}) 
					return
				}			
			}			
