                    ...
                    <?php 
                       ...
                       ?>
						...
						$acces_user_log = $_SESSION["username"];
						  ...
						  WHERE status_wo='Belum Terpasang' and pic_ikr='-' 
						...
						$acces_user_log = $_SESSION["username"];
						  ...
						  WHERE status_wo='Belum Terpasang' and pic_ikr='-' and kd_layanan='".$kota."' ORDER BY key_fal DESC");
						  while ($row = mysqli_fetch_assoc($table)){ 
						  $i=0;
						  $no=1;
		...
		$(document).on('click', '.editproses', function(){
			//var nama_fal = $("#nama_fal").val();
			 ...
			 var value = { key_fal:key_fal,nama_fal:nama_fal,username_fal:username_Maintenance,pic_ikr:pic_ikr,
				...
				type: "POST",
				async: false,
				url: "../controller/action_proses_newversion.php",
				data: value,
				 success : function(data) {
				var a = data;
