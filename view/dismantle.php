            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">DISMANTLsssE NON KAPTEN<?php //echo $_SESSION["level_user"]; 
                                                                                    ?></h1>
                        <?php
                        ...
                        ?>
                            <div>
                                ...
                                <a href="controller/export_dismantle.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                    ...
                    ?>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <button class="btn btn-success add-data">aaaaa +</button>
                ...
                <div class="modal-body">
                    <form action="" id="formdatapengguna">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="fname">tgl dismantle</label>
                                <input class="form-control" type="text" id="username_fal" name="username_fal" placeholder="nama..." autocomplete="off">
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select class="form-control" type="text" id="status" name="status" autocomplete="off" required>
                                    ...
                                    <option>Rino#Karyawan</option>
                                    <option>Fio#Karyawan</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    "url": "../models/datapenggunaDISMANTLE.php",
                    "type": "POST",
                },
                "paging": true,
                "lengthChange": true,
            ...
            $(".submitdata").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    async: false,
                    url: "../controller/action_dismentle.php",
                    data: value,
            ...
            $(document).on('click', '.editpengguna', function() {
                var id = $(this).attr("id");
                $.ajax({
                    url: "../controller/get_data_dismantle.php",
                    method: "POST",
                    data: {
                        id: id
                    },
