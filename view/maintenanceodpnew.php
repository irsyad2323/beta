            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Maintenance ODP <?php //echo $_SESSION["level_user"]; ?></h1>
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Maintenance ODP Belum Terpasang</h6>
							</div>
							<div class="card-body">
								  ...
								  <tbody> 
									<?php 
										...
										$acces_user_log = $_SESSION["username"];
										  $table = mysqli_query($koneksi,"SELECT a.*, b.alamat_odp FROM tbl_maintenance_odp a, tbl_odp b
WHERE a.id_odp = b.id_odp and a.jenis_wo='MAINTENANCE_ODP' and a.status_wo in ('Belum Terpasang','Proses Pengerjaan') 
and a.kd_layanan like '".$kota."' ORDER BY a.key_fal DESC");
										  $no=1;
										  ...
										  $i=0;
											...
											/*   if ($date_ins > $date_now ) {
												...
												if(strtotime($date_ins) < strtotime('-1 day')){
													$row['hasil_danger'] = '<small class="badge badge-danger">'. strtoupper($row['tgl_sign']).'</small>';
												}else{
													$row['hasil_danger'] = '<small class="badge badge-success">'. strtoupper($row['tgl_sign']).'</small>';
												}
										  ?>
										  <tr id=<?php echo $no; ?>">
											...
											<td data-target="alamat_fal"> <?php echo $row['alamat_odp'];?></td>
					...
					<?php 
                       ...
                       ?>
							...
							<div class="form-row">
								...
								<select class='js-example-basic-multiple' id="kode_user" name="kode_user" multiple="multiple" style='width: 250px;' >
					     <option> <?php
											  $conn = mysqli_connect("117.103.69.22", "kocak", "gaming", "billkapten");
											  $sql_user = mysqli_query($conn, "SELECT * FROM tbl_odp where kd_layanan='".$kota."'");
						...
						<br/>
							...
							<div class="form-row">
								...
								<input class="form-control" type="text" id="lain_lain" name="lain_lain" autocomplete="off">
							</div>
						<br/>
						...
						<br/>  
                            <div class="form-row">
                                ...
                                <input class="form-control" type="text" id="nama_fal" name="nama_fal" placeholder="nama..." readonly>
                            </div>
						<br/>	
							
							<div class="form-row">
								<label for="fname">ID odp</label>
                                <input class="form-control" type="text" id="username_Maintenance" name="username_Maintenance" readonly>
							</div>   
						<br/>
                                                 
                            <div class="form-row">
								<label for="lname">Alamat</label>
								<input class="form-control" type="text" id="alamat_fal" name="alamat" readonly>
							</div>
						<br/>
...
//alert (a);
    $.ajax({
		...
		var hasil = JSON.parse(data);
		   $('#username_Maintenance').val(hasil.id_odp);
           $('#nama_fal').val(hasil.nama_odp);
		   $('#alamat_fal').val(hasil.alamat_odp);		   
         ...
         $(document).ready(function() {
			...
			var table = $('#tabel_solved').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"../models/datapengguna_maintenance_ts.php",
			...
			if(username_Maintenance == '' ){
			 ...
			 var value = { 
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_insert_mntnodp.php",
                    data: value,
                    success : function(data) {
					//alert(data);
					Swal.fire(
            ...
            var username_log = $("#username_log").val();	
			 ...
			 var value = { 
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_switch_mntnodp.php",
                    data: value,
                    success : function(data) {
					//alert(data);
					Swal.fire(
            ...
            $(document).on('click', '.deletepengguna', function(){
...

                {
                    ...
                    $.ajax({
                        ...
                        url:"../controller/delete_mntnodp.php",
