            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">IKR Dedicated <?php //echo $_SESSION["level_user"]; ?></h1>
                        <?php 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" id="formdatapengguna">
                        <div class="form-row">
							...
							<div class="form-group col-md-2">
                                <label for="rang">KODE Dedicated</label>                
                     <select class='form-control' id="OLT" name="OLT" >
					    <option></option>						
						<option value="DC">Dedicated</option>						
						
						</select> &nbsp
                            </div> 
                            <div class="form-group col-md-2">
                            <label for="rang">ID User</label>
                            <input class="form-control" type="text" id="username_fal" name="username_fal" placeholder="id..." autocomplete="off" >
                        </div>
                            <div class="form-group col-md-2">
                   ...
                   <div class="form-group col-md-6">
					...
					<option>satria#Outsourcing</option>                                                 
                    <option>ubed#Outsourcing</option>					
                    </select>
                  </div>
	...
	<script>
         $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    "url":"../models/datapengguna_dedicated.php",
                    "type":"POST",
                },
                "paging": true,
                "lengthChange": true,
            ...
            var value = { action:action, nama_fal:nama_fal, kd_layanan:kd_layanan, pic_ikr:pic_ikr,alamat_fal:alamat_fal, rt:rt,rw:rw,kelurahan:kelurahan,tlp_fal:tlp_fal, pic:pic , status:status, status2:status2, jenis_wo:jenis_wo,produk:produk,modem:modem,kabel1:kabel1,kabel2:kabel2,kabel3:kabel3,paket_fal:paket_fal, tgl_fal:tgl_fal, username_fal:username_fal, username_Maintenance:username_Maintenance, password_fal:password_fal, status_wo:status_wo,lain_lain:lain_lain, ket:k }; 

                $.ajax({
                    type: "POST",
					async: false,
                    url: "../controller/action_dedicated.php",
                    data: value,
            ...
            $(document).on('click', '.editpengguna', function(){
                var id = $(this).attr("id");
                $.ajax({
                    url:"../controller/get_data_dedicated.php",
                    method:"POST",
                    data:{id:id},
                    dataType:"JSON",
                    success:function(data)
...
//alert (a);
    $.ajax({
        url: "../create/create_kode_user_sinden.php",
        data: { "value": $("#OLT").val() },
        //dataType:"html",
        type: "post",
        success: function(data){
