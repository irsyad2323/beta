	...
	<?php include '../sidebar.php'; ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">WO LAIN LAIN<?php //echo $_SESSION["level_user"]; ?></h1>
                        <?php 
		...
		<!-- Begin Page Content -->
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">DATA WO LAIN LAIN</h6>
							</div>
							<div class="card-body">
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">DATA WO LAIN LAIN SUDAH</h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
								<table class="table table-bordered" id="tabel_lain" width="100%" cellspacing="0">
								  <thead>
									<tr>
									<th>NO</th>                          
									<th>Tanggal WO</th>
                 ...
                 <div class="modal-body">
                    ...
                    <option> <?php
											 ...
											 while ($data_user = mysqli_fetch_array($sql_user)) {
												echo '<option value"'.$data_user['user'].'">'.$data_user['nama_panggilan'].'#'.$data_user['status_karyawan'].'</option>';
											  } 
											?>   </option> 
					<option> <?php
											  include('../controller/controller_mysqli.php');
			...
			<form role="form" method="post" id='formdatapengguna'>
                           ...
                           <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input class="form-control" type="text" id="nama" name="nama" placeholder="nama..." autocomplete="off">
                            </div>                                             
                   ...
                   <select class="form-control" type="text" id="pic_ikr" name="pic_ikr" autocomplete="off">
								<option> <?php
											  include('../controller/controller_mysqli.php');
											  $sql_user = mysqli_query($koneksi, "SELECT * FROM tbl_pegawai WHERE status_pegawai='aktiv' and status_karyawan in ('Karyawan','Outsourcing') and jabatan in ('teknisi','marketing','software','Keuangan','ujm','manager') and kantor_cabang = '".$kota."';");
											  //$data_user = mysqli_fetch_array($sql_user);
											  //print_r($data_user);
											 while ($data_user = mysqli_fetch_array($sql_user)) {
												echo '<option value"'.$data_user['user'].'">'.$data_user['user'].'</option>';
											  } 
											?>   </option>                                             
                    </select>
                            </div>                           
                   ...
                   <div class="form-group col-md-6">
                        ...
                        <hr>
                            <button type="button" class="btn btn-success  pull-right gass">Insert</button>
                            <button type="reset" class="btn btn-danger pull-right"><i class="fa fa-times fa-fw"></i>Reset</button>
                        </form>
	...
	<script>
		 $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
             ...
             var table = $('#tabel_lain').DataTable({
		...
		$(document).on('click', '.saveupdate9', function(){
			...
			// create 			
		$(document).on('click', '.gass', function(){
			//var nama_fal = $("#nama_fal").val();
			 var nama = $('#nama').val();
			 var produk = $('#produk').val();
			 var kd_layanan = $('#kd_layanan').val();
			 ...
			 var value = { nama:nama,
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_insert_lain.php",
                    data: value,
                    success : function(data) {
					alert(data);
					window.location.reload(true);
