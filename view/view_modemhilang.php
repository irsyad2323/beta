                    ...
                    <?php 
                       ...
                       ?>
						...
						$acces_user_log = $_SESSION["username"];
						  $table = mysqli_query($koneksi,"SELECT * FROM tbl_disable_noconfirm WHERE kd_layanan like '".$kota."' and kategori_pelanggan IN ('Orang tidak ada + modem tidak ada','Orang ada + modem tidak ada','orang tidak ada + modem ada') ORDER BY key_fal DESC");
			...
			//var nama_fal = $("#nama_fal").val();
			 ...
			 var value = { nama_berhenti:nama_berhenti,
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_pelangganberhenti_update2.php",
                    data: value,
                    success : function(data) {
					alert(data);
