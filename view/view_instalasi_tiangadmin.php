            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Instalasi Tiang Baru<?php //echo $_SESSION["level_user"]; ?></h1>
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Instalasi Tiang Not Verified</h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
								<table class="table table-bordered" id="tabel_data" width="100%" cellspacing="0">
								  <thead>
									<tr>
									  <th></th>
									  <th>NO</th>
								...
								<div class="d-sm-flex align-items-center justify-content-between mb-4">
									<button type="submit" id="set" name="set" class="btn btn-success margin pull-right">ACTION EDIT CEKLIST</button>
								</div>
                 ...
                 <div class="modal-body">
					...
					<?php 
                       ...
                       ?>
						 ...
						 <div class="form-row">
                                <label for="rang">LABEL TIANG</label>                
									<select class="form-control" type="text" id="id_tiang" name="id_tiang" autocomplete="off" readonly>
									 <?php
						...
						<br/>
                            ...
                            <div class="form-row">
                                <label for="fname">Arah Tiang Dari jalan</label>
                                <select class="form-control" type="text" id="nama_tiang" name="nama_tiang" autocomplete="off" required>								
								<option>Timur</option>												
								<option>Barat</option>												
						...
						<br/>	
                            ...
                            <div class="form-row">
                                <label for="fname">Jenis Tiang</label>
                                <select class="form-control" type="text" id="jenis_tiang" name="jenis_tiang" autocomplete="off" required>								
								<option></option>												
  ...
  <div class="modal-dialog">
	...
	<div class="modal-body">		
	  <div class="box-header with-border">
		...
		<div class="form-row">
							<label for="rang">Verifikasi</label> 
							<select class="form-control" type="number" id="verifikasi2" name="verifikasi2" autocomplete="off">
							<option value=""></option>
							<option value="Sudah Dikerjakan">Verifikasi</option>											
							</select>
						</div>
	...
	$(document).ready(function() {
		var table = $('#tabel_data').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"../models/modal_tiang_notsolvedadmin2.php",
	...
	$("#set").click(function(event){
		...
		//var lognya = this;
		var otable = $('#tabel_data').DataTable();
...
$('#submit_select_client').click(function(event){
	...
	var verifikasi = $("#verifikasi2").val();
    //alert (verifikasi2); return;
