							...
							-->
								...
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h6 class="m-0 font-weight-bold text-primary">Verified Pendaftaran</h6>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											<table class="table table-bordered" id="tabel_pengguna" width="100%"
												cellspacing="0">
												<thead>
													<tr>
														<th>Key</th>
												...
												<tbody>
													...
													$table = mysqli_query($koneksi, "SELECT a.userid_app,a.jenis,a.key_fal,a.rt,a.rw,a.provinsi,a.kabupaten,a.kecamatan,a.kelurahan,
       a.status_lokasi,'-' as nama_sobat,'-' as metode_pembayaran,'-' as no_rekening,'-' as an_rek,'-' as wa_sobat,
       'reguler' as mgm,a.paket_kapten,a.nama_lengkap,a.alamat,a.no_wa,a.no_wa2,a.no_wa3,a.no_wa4,a.patokan,
       a.foto_ktp,a.foto_rumah,a.tahu_layanan,a.alasan,a.lokasi,a.layanan,
       b.nama_provinsi,c.nama_kabkota,d.nama_kec,e.nama_kel,a.tanggal, f.`level`, f.nama_sobat
FROM tb_daf a
...
LEFT JOIN tbl_sobat_mgm f ON a.kode_referral = f.id
WHERE a.status='n' AND a.stts_ver='n'
  AND a.kabupaten=d.kd_kabkota AND d.kd_kec=e.kd_kec AND c.kd_kabkota=e.kd_kabkota
  AND a.layanan IN ('mlg','mlg1','batu','pas','pas1')
...
");
													...
													while ($row = mysqli_fetch_assoc($table)) {
														...
														if ($row['jenis'] == 'kapten') {
															$row['jenis_stt'] = '<small class="badge badge-dark">KAPTEN</small>';
														} elseif ($row['jenis'] == 'combo') {
															$row['jenis_stt'] = '<small class="badge badge-danger">COMBO</small>';
														} elseif ($row['jenis'] == 'edu') {
															$row['jenis_stt'] = '<small class="badge badge-warning">EDUBIZ</small>';
														} elseif ($row['jenis'] == 'auratech') {
															$row['jenis_stt'] = '<small class="badge badge-primary">AURATECH</small>';
														} elseif ($row['jenis'] == 'nc') {
															$row['jenis_stt'] = '<small class="badge badge-primary">NC (Linknet)</small>';
														} elseif ($row['jenis'] == 'superstar') {
															$row['jenis_stt'] = '<small class="badge badge-primary">Superstar</small>';
														}
														...
														<td data-target="i"> <?php echo $i; ?></td>
															...
															<td data-target="nama_sobat"> <?php echo $row['nama_sobat']; ?>
															</td>
															<td data-target="jenis_unit"> <?php echo $row['jenis_unit']; ?>
															</td>
															<td data-target="nama_lengkap">
																<?php echo $row['nama_lengkap']; ?>
															</td>
															<td data-target="no_wa"> <?php echo $row['no_wa']; ?></td>
															<td data-target="paket_kapten">
																<?php echo $row['paket_kapten']; ?>
															</td>
															<td data-target="jenis_stt"> <?php echo $row['jenis_stt']; ?>
															</td>
															<td>
																<div class="dropdown">
																	...
																	<div class="dropdown-menu"
																		...
																		<a href="#" class="dropdown-item"
																			...
																			data-foto="<?php echo $row['foto_ktp']; ?>">
																			Foto KTP
																		</a>

																		<!-- Tombol buka modal Foto Rumah -->
																		<a href="#" class="dropdown-item"
																			data-toggle="modal" data-target="#modalFoto"
																			data-foto="<?php echo $row['foto_rumah']; ?>">
																			Foto Rumah
																		</a>
																		<a href="https://wa.me/<?php echo $row['no_wa']; ?>"
																			target="_blank" class="dropdown-item">
																			Whatsapp</a>
																		<a href="<?php echo $row['lokasi']; ?>"
																			target="_blank" class="dropdown-item">
																			Maps</a>
																		<button type="button" name="edit"
																			...
																			userid_app="<?php echo $row['userid_app']; ?>"
																			class="dropdown-item ver_pen">Verified
																			Pendaftaran</button>
																		<button type="button" name="edit"
																			data-id="<?php echo $row['key_fal']; ?>"
																			key_fal="<?php echo $row['key_fal']; ?>"
				...
				<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
					<div class="modal-content">
						...
						<div class="modal-body text-center">
							<img id="previewFoto" src="" class="img-fluid rounded shadow" alt="Foto">
						</div>
					</div>
				</div>
			</div>
							...
							<form role="form" method="post" id="formdatapengguna">
								...
								if ($_SESSION["level_user"] != "ikr") {
									...
									<div class="form-row">
										...
										<select class="form-control" type="text" id="pic_ikr" name="pic_ikr"
											autocomplete="off">
											<option>-</option>
									...
									<div class="form-row">
										...
										<select class="form-control" type="text" id="paket_fal" name="paket_fal"
											autocomplete="off">
											<option>-</option>
											<option>5</option>
											<option>10</option>
									...
									<div class="form-row">
										...
										<input class="form-control" type="text" id="username_fal" name="username_fal"
											autocomplete="off" readonly>
									</div>
									<br />
									<div class="form-row">
										<label for="fname">Nama</label>
										<input class="form-control" type="text" id="nama_fal" name="nama_fal"
									...
									<div class="form-row">
										...
										<input class="form-control" type="number" id="no_wa" name="no_wa"
									...
									<div class="form-row">
										...
										<input class="form-control" type="text" id="password_fal" name="password_fal"
									...
									<div class="form-row">
										...
										<select class="form-control" type="text" id="kd_layanan" name="kd_layanan"
									...
									<div class="form-row">
										...
										<input class="form-control" type="text" id="alamat_fal" name="alamat"
											placeholder="alamat..." autocomplete="off">
									</div>
									<br />

									<div class="form-row">
										<input class="form-control" type="hidden" id="rt" name="rt" placeholder="rt..."
											autocomplete="off">
									</div>
									...
									<div class="form-row">
										<input class="form-control" type="hidden" id="rw" name="rw" placeholder="rw..."
											autocomplete="off">
									</div>


									<div class="form-row">
										<input class="form-control" type="hidden" id="kelurahan" name="kelurahan"
											placeholder="kelurahan..." autocomplete="off">
									</div>


									<div class="form-row">
										<input class="form-control" type="hidden" id="kecamatan" name="kecamatan"
											placeholder="kelurahan..." autocomplete="off">
									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="kabupaten" name="kabupaten"
											placeholder="kelurahan..." autocomplete="off">
									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="provinsi" name="provinsi"
											placeholder="kelurahan..." autocomplete="off">
									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="lokasi" name="lokasi"
											placeholder="kelurahan..." autocomplete="off">
									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="status_lokasi" name="status_lokasi"
											placeholder="kelurahan..." autocomplete="off">
									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="tahu_layanan" name="tahu_layanan"
											placeholder="kelurahan..." autocomplete="off">
									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="alasan" name="alasan"
											placeholder="kelurahan..." autocomplete="off">
									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="foto_rumah" name="foto_rumah"
											placeholder="kelurahan..." autocomplete="off">

									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="foto_ktp" name="foto_ktp"
											placeholder="kelurahan..." autocomplete="off">
									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="no_wa2" name="no_wa2"
											autocomplete="off">

									</div>

									<div class="form-row">
										<input class="form-control" type="hidden" id="no_wa3" name="no_wa3"
											autocomplete="off">
									...
									<div class="form-row">
										<input class="form-control" type="hidden" id="no_wa4" name="no_wa4"
											autocomplete="off">
									...
									<div class="form-row">
										...
										<input type="datetime-local" name="tgl_fal" id="tgl_fal"
									...
									<div class="form-row">
										...
										<input class="form-control" type="text" id="lain_lain" name="lain_lain"
									...
									<div class="form-row">
										...
										<select class='form-control' id="perlakuan" name="perlakuan" onclick='test()'>
											...
											<option value="Free Biaya Instalasi & Free Biaya Bulanan">Free Biaya Instalasi &
												Free Biaya Bulanan</option>
									...
									<div class="form-row">
										...
										<input class="form-control" type="number" id="total_diskon" name="total_diskon"
											placeholder="total diskon" style="display: none">

										<select class="form-control" type="number" id="free" name="free" autocomplete="off"
											style="display: none">
											<option></option>
										...
										<input class="form-control" type="number" id="keterangan_angsuran"
											name="keterangan_angsuran" placeholder="angsuran pertama" style="display: none">
										<input class="form-control" type="number" id="pindah_alamat" name="pindah_alamat"
											placeholder="tarif pindah alamat" style="display: none">
									</div>
									<br />
									...
									<hr>
									<button type="button"
										class="btn btn-success  pull-right action_post_kap">Insert</button>
									<button type="reset" class="btn btn-danger pull-right"><i
			...
			<div class="modal fade" id="modaledit" role="dialog" tabindex="-1" aria-labelledby="exampleModalLongTitle"
				aria-hidden="true">
							...
							<form role="form" method="post" id="formdatapengguna">
								...
								if ($_SESSION["level_user"] != "ikr") {
									...
									<div class="form-row">
										...
										<select class="form-control" type="text" id="jenis_pekerjaan" name="jenis_pekerjaan"
											autocomplete="off">
											<option></option>
									...
									<div class="form-row">
										<label for="rang">ID User</label>
										<input class="form-control" type="text" id="username_fal2" name="username_fal2"
											autocomplete="off" disabled>
									</div>
									<br />
									<div class="form-row">
										<label for="fname">Nama</label>
										<input class="form-control" type="text" id="nama_fal2" name="nama_fal2"
											placeholder="nama...">
									</div>
									<br />
									...
									<div class="form-row">
										<label for="halaman">NO. Telepon</label>
										<input class="form-control" type="number" id="tlp_fal2" name="tlp_fal2"
											placeholder="telepon.." autocomplete="off">
									</div>
									<br />
									...
									<div class="form-row">
										<label for="rang">Password</label>
										<input class="form-control" type="text" id="password_fal2" name="password_fal2"
											placeholder="password" autocomplete="off">
									</div>
									<br />
									...
									<div class="form-row">
										<label for="rang">Paket</label>
										<select class="form-control" type="text" id="paket_fal2" name="paket_fal2"
											autocomplete="off">
											<option>-</option>
											<option>5</option>
											<option>10</option>
									...
									<div class="form-row">
										<label for="rang">kantor Cabang</label>
										<select class="form-control" type="text" id="kd_layanan2" name="kd_layanan2"
											autocomplete="off" required>
											<option><?php echo $kota ?></option>
											<?php if ($_SESSION["level_kantor"] != "pas" && $_SESSION["level_kantor"] != "batu" && $_SESSION["level_kantor"] != "mlg") { ?>
												<option>mlg</option>
									...
									<div class="form-row">
										<label for="rang">Pic IKR</label>
										<select class="form-control" type="text" id="pic_ikr2" name="pic_ikr2"
											autocomplete="off">
											<option>-</option>
											<option>rafif</option>
											<option>wawan</option>
									...
									<div class="form-row">
										<label for="lname">Alamat</label>
										<input class="form-control" type="text" id="alamat_fal2" name="alamat_fal2"
											placeholder="alamat..." autocomplete="off">
									</div>
									<br />
									...
									<div class="form-row">
										...
										<input class="form-control" type="text" id="rt2" name="rt2" placeholder="rt..."
											autocomplete="off">
									</div>
									<br />
									...
									<div class="form-row">
										...
										<input class="form-control" type="text" id="rw2" name="rw2" placeholder="rw..."
											autocomplete="off">
									</div>
									<br />
									...
									<div class="form-row">
										...
										<input class="form-control" type="text" id="kelurahan2" name="kelurahan2"
											placeholder="kelurahan..." autocomplete="off">
									</div>
									<br />
									...
									<div class="form-row">
										<label for="rang">Keterangan</label>
										<input class="form-control" type="text" id="lain_lain2" name="lain_lain2"
											placeholder="keterangan" autocomplete="off">
									</div>
									<br />
									...
									<div class="form-row">
										<label for="rang">Perlakuan Khusus</label>
										<input class="form-control" type="number" id="total_diskon2" name="total_diskon2"
									...
									<div class="form-row">
										...
										<select class="form-control" type="number" id="free2" name="free2"
											autocomplete="off">
											<option></option>
											<option>340000</option>
											<option>395000</option>
									...
									<div class="form-row">
										...
										<input class="form-control" type="number" id="keterangan_angsuran2"
											name="keterangan_angsuran2" placeholder="angsuran pertama">
									</div>
									<br />
									<div class="form-row">
										<label for="rang">Pindah Alamat</label>
										<input class="form-control" type="number" id="pindah_alamat2" name="pindah_alamat2"
											placeholder="tarif pindah alamat">
									</div>
									<br />
			...
			<div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
				aria-hidden="true">
			...
			<!-- Script untuk load foto base64 -->
			<!-- Script untuk load foto base64 -->
			<script>
				$('#modalFoto').on('show.bs.modal', function (event) {
					var button = $(event.relatedTarget);
					var foto = button.data('foto'); // langsung ambil base64 dari DB
					var modal = $(this);
					modal.find('#previewFoto').attr('src', foto);
				});
			</script>
			...
			<script>
				$(document).on('click', '.ver_pen', function () {
					//const key_fal = $(this).attr("key_fal");
					const key_fal = $(this).attr('key_fal');
					const mgm = $(this).attr('mgm');
					const nama_lengkap = $(this).attr('nama_lengkap');
					const alamat = $(this).attr('alamat');
					const nama_sobat = $(this).attr('nama_sobat');
					const metode_pembayaran = $(this).attr('metode_pembayaran');
					const no_rekening = $(this).attr('no_rekening');
					const userid_app = $(this).attr('userid_app');
					//alert(userid_app); return;
					if (mgm == 'reguler') {

						// SweetAlert for confirmation
						Swal.fire({
							title: 'Detail Aprove Reguler',
							html: "Nama : " + nama_lengkap
								+ "<br> Alamat : " + alamat, // Gunakan html untuk multiline text
							icon: 'warning',
							...
							if (result.isConfirmed) {
								...
								xhr.open("POST", "../controller/action_verif_pen.php", true);
								...
								xhr.onreadystatechange = function () {
									if (xhr.readyState === 4 && xhr.status === 200) {
										...
										if (response.success) {
											...
											Swal.fire(
												'Error!',
												'There was an error editing your data.',
												'error'
											);
										}
									}
								};
								xhr.send("key_fal=" + key_fal + "&mgm=" + mgm + "&userid_app=" + userid_app + "&nama_lengkap=" + nama_lengkap);
							}
						});
						...
						// SweetAlert for confirmation
						Swal.fire({
							title: 'Detail Aprove MGM',
							html: "Nama : " + nama_lengkap
								+ "<br> Alamat : " + alamat
								+ "<br> Nama MGM : " + nama_sobat
								+ "<br> Metode pembayaran : " + metode_pembayaran
								+ "<br> No Rekening : " + no_rekening, // Gunakan html untuk multiline text
							icon: 'warning',
							showCancelButton: true,
							confirmButtonColor: '#3085d6',
							cancelButtonColor: '#d33',
