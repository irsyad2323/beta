                ...
                <div class="modal-header">
                 ...
                 <div class="modal-body">
                    ...
                    <option> <?php
											  ...
											  $sql_user = mysqli_query($conn, "SELECT * FROM tbl_pegawai WHERE kantor_cabang='$kota' and status_pegawai='aktiv' and status_karyawan='PKL';");
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                 ...
                 <div class="modal-body">
                    ...
                    <option> <?php
											  $conn = mysqli_connect("117.103.69.22", "kocak", "gaming", "billkapten");
											  $sql_user = mysqli_query($conn, "SELECT * FROM tbl_pegawai WHERE kd_layanan='$kota' and status_pegawai='aktiv' and status_karyawan='PKL';");
											  //$data_user = mysqli_fetch_array($sql_user);
											  //print_r($data_user);
											 while ($data_user = mysqli_fetch_array($sql_user)) {
												echo '<option value"'.$data_user['nama_panggilan'].'">'.$data_user['nama_panggilan'].' </option>';
