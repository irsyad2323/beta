                    ...
                    <?php 
                       ...
                       ?>
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Maintenance </h6>
							</div>
							<div class="card-body">
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Maintenance ODP </h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
			...
			<form role="form" method="post" id='formdatapengguna'>
                           ...
                           <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <label for="rang">kantor Cabang</label>                
                    <select class="form-control" type="text" id="kd_layanan" name="kd_layanan" autocomplete="off" disabled>
                    <option>mlg</option>
                    <option>pas</option>                                   
                    </select>
                            </div> 
