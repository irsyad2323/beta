                    ...
                    <?php 
                       ...
                       ?>
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Ambil WO IKR</h6>
							</div>
							<div class="card-body">
						...
						$acces_user_log = $_SESSION["username"];
						  $table = mysqli_query($koneksi,"SELECT (a.hrg_ins + a.hrg_pkt - a.total_diskon) as total,a.*,b.harga, CONCAT(angsuran1,'   ',verif1) angsuran_fix1, CONCAT(angsuran2,'   ',verif2) angsuran_fix2
														FROM tbl_fal a
														INNER JOIN price_harga b
																ON a.paket_fal = b.paket
														WHERE status_wo='Belum Terpasang' and pic_ikr='".$acces_user_log."' and produk='Kapten Naratel' and jenis_wo='INSTALASI' and verified='not_verified'
						  ...
						  <tr id=<?php echo $row['username_fal']; ?>">
							...
							class="btn btn-warning btn-sm mr-2 editpros">Proses</button>
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							...
							<div class="card-body">
							  <div class="table-responsive">
								<table class="table table-bordered" id="tabel_p" width="100%" cellspacing="0">
								  <thead>
									<tr>
									<th>NO</th>
									<th>Nama</th>
						...
						$acces_user_log = $_SESSION["username"];
						  $table = mysqli_query($koneksi,"SELECT (b.harga - a.total_diskon) as total,a.*,b.harga, CONCAT(angsuran1,'   ',verif1) angsuran_fix1, CONCAT(angsuran2,'   ',verif2) angsuran_fix2
														...
														INNER JOIN price_harga b
																ON a.paket_fal = b.paket
														WHERE status_wo in ('Proses Pengerjaan') and pic_ikr='".$acces_user_log."' and produk='Kapten Naratel' and jenis_wo='INSTALASI' and verified='not_verified'
														ORDER BY key_fal DESC");
																				  while ($row = mysqli_fetch_assoc($table)){ 
																				  $i=0;
																				  $no=1;
												...
												<div class="dropdown">
												 ...
												 Foto Rumah</a>
													<a name="edit" data-id="<?php echo $row['username_fal'];?>"
														...
														keterangan_angsuran="<?php echo $row['keterangan_angsuran'];?>"
														total="<?php echo $row['total'];?>"
														class="dropdown-item editkapten" >Solved</a>
													<a class="dropdown-item" href="https://api.whatsapp.com/send?phone=<?php echo $row['tlp_fal'];?>">Hubungi</a>
												  </div>
												</div>
											</td>
						  </tr>
...
ORDER BY key_fal DESC");
					...
					<!-- Begin Page Content -->
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Instalasi Sinden</h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Instalasi Omah Wifi</h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
								<table class="table table-bordered" id="tabel_pengguna_omahwifi" width="100%" cellspacing="0">
								  <thead>
									<tr>
									<th>NO</th>
									<th>Nama</th>
					  ...
					  <!-- Begin Page Content -->
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Instalasi Dedicated</h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
					 ...
					 <!-- Begin Page Content -->
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Instalasi Broadband</h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
            ...
            <div class="modal-content">
			  ...
			  <div class="form-group col-md-6" >
               ...
               <div class="form-group col-md-6">
                    ...
                    <option>Masalah Perijinan</option>
	...
	<!-- Modal -->
<div class="modal fade" id="modalpros" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">PERATURAN PROSES IKR</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         Teknisi harus berada dilokasi pelanggan (Rumah Pelanggan)..
		   <form role="form" method="post">
				<input class="form-control" type="hidden" id="username_fal2" name="username_fal2" autocomplete="off" >
				<input class="form-control" type="hidden" id="proses_lokasi" name="proses_lokasi" autocomplete="off" >
			<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			<button type="button" class="btn btn-primary editprosikr">Save changes</button>
		</form>
      </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-content">
			  ...
			  <div class="form-group col-md-6" >
                        ...
                        <div class="form-group col-md-6" >
							<label for="rang">Tekan Tombool Show Position</label>  
                            <input class="form-control" type="text" id="get_lokasi" name="get_lokasi" autocomplete="off" readonly>   
                        </div>
				</div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-content">
			  ...
			  <div class="form-group col-md-6" >
                        ...
                        <div class="form-group col-md-6" >
							<label for="rang">Tekan Tombool Show Position</label>  
                            <input class="form-control" type="text" id="get_corporate" name="get_corporate" autocomplete="off" readonly>   
                        </div>
				</div>
...
/* $(document).ready(function() {
    ...
    <script>
		...
		$(document).on('click', '.savekapten', function(){
			...
			if(status_wo == ''){
				Swal.fire({
				  icon: 'error',
				  title: 'Oops...',
				  text: 'Status Pekerjaan Belum Terisi!',
		...
		$(document).on('click', '.save_corporate', function(){
			...
			// create 			
		const proses_lokasi = document.getElementById("proses_lokasi");
		...
		function showPosition(position) {	
		  proses_lokasi.value = 'https://www.google.com/maps/search/?api=1&query=' + position.coords.latitude + "," + position.coords.longitude;
		}
		getLocation();
	
		$(document).on('click', '.editprosikr', function(){
			var username_fal2 = $("#username_fal2").val();
			var proses_lokasi = $("#proses_lokasi").val();
			 //var username_fal2 = $(this).attr('username_fal2');
			 //alert (proses_lokasi);
			...
			if(proses_lokasi == ""){
				Swal.fire({
				  icon: 'error',
				  title: 'Oops...',
				  text: 'GPS diurupno Bro!!',	
				}) 
				return;
			}
			 
			 var value = { username_fal:username_fal2,proses:proses_lokasi,
						 }; 
            ...
            $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_proses_ikr.php",
                    data: value,
                    success : function(data) {
					//alert(data);
					Swal.fire(
