...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Instalasi Kendala Perijinan <?php //echo $_SESSION["level_user"]; ?></h1>
											...
											<td>
												<div class="dropdown">
												 ...
												 Foto Rumah</a>
														...
														status_wo="<?php echo $row['status_wo'];?>"
														lain_lain="<?php echo $row['lain_lain'];?>"
														class="dropdown-item pending">Status</a>
												  </div>
												</div>
											</td>
										  </tr>
	...
	<div class="modal fade" id="modal_pending"  role="dialog" tabindex="-1" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                ...
                <div class="modal-header">
                 ...
                 <div class="modal-body">
					...
					<?php 
                        if ($_SESSION["level_user"] != "ikr"){
                       ?>
						<input class="form-control" type="hidden" id="key_fal_pending" name="key_fal_pending" autocomplete="off">
						<div class="form-row">
								<label for="rang">Keterangan</label>
								<input class="form-control" type="text" id="lain_lain_pending" name="lain_lain_pending" placeholder="keterangan" autocomplete="off">
							</div>
						<br/>  

						<div class="form-row">
                                <label for="rang">Status Pelanggan</label>                
									<select class="form-control" type="text" id="status_wo_pending" name="status_wo_pending" autocomplete="off" >
									<option></option>
									<option value="Proses Pengerjaan">Post WO</option>                   
									</select>
                            </div>
						<br/>
						...
						<hr>
                            <button type="button" class="btn btn-success  pull-right actionpending">Save</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
	...
	<script>
		...
		$(document).on('click', '.pending', function(){
               // alert('a');
				...
				$('#key_fal_pending').val(key_fal);				
				$('#status_wo_pending').val(status_wo);				
				$('#lain_lain_pending').val(lain_lain);	
				
            });
			
			// Edit 			
		$(document).on('click', '.actionpending', function(){
            var key_fal_pending = $("#key_fal_pending").val();
            var lain_lain_pending = $("#lain_lain_pending").val();
            var status_wo_pending = $("#status_wo_pending").val();
			
			//alert(nama_fal2); return;
			 
			if(status_wo_pending == '' ){
				Swal.fire({
				  icon: 'error',
				  title: 'Oops...',
			 ...
			 var value = { 
						  lain_lain_pending:lain_lain_pending,
						  status_wo_pending:status_wo_pending,
						  key_fal_pending:key_fal_pending,
						 }; 
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_mslh_pending.php",
                    data: value,
