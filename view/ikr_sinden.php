            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Instalasi Sinden <?php //echo $_SESSION["level_user"]; ?></h1>
                        ...
                        <div>                          
                            ...
                            <a href="controller/export_sinden.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="modal-content">
                       ...
                       ?>
						 ...
						 <div class="form-row">
							...
							<div class="form-group col-md-2">
                                <label for="rang">KODE SINDEN</label>                
               ...
               <div class="form-group col-md-6">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="number" id="kabel1" name="kabel1" autocomplete="off" required>                    
						</div>
         ...
         $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"../models/datapengguna_sinden.php",
			...
			if(nama_fal == '' || username_fal == '' || alamat_fal == '' || kelurahan == '' || tlp_fal == null ){
            ...
            var value = { action:action, 
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_sinden.php",
