    ...
    <div id="wrapper">
        ...
        <!-- Sidebar - Brand -->
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../index.php">
                ...
                <div class="sidebar-brand-text mx-3">WO PT. NARAYA TELEMATIKA</div>
        ...
        <!-- Collapse Menu -->
            ...
            <hr class="sidebar-divider my-0">
                ...
                <div id="home" class="collapse" aria-labelledby="headingUtilities"
...
<?php if ( $_SESSION["level_user"] != "adminwo_fulus" && $_SESSION["level_user"] != "psg_dcp" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "ts" && $_SESSION["level_user"] != "Admin" ){ ?>						
						<a class="collapse-item" href="../index_export.php">EXPORT EXCEL</a> 

						<a class="collapse-item" href="../view_gamas.php">GANGGUAN MASSAL</a>
<?php } ?>
                    </div>
...
<?php if ( $_SESSION["level_user"] != "adminwo_fulus" && $_SESSION["level_user"] != "psg_dcp" ){ ?>	
			<li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <h6 class="collapse-header">INSTALASI</h6>
						
						
		<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "super" && $_SESSION["level_user"] != "adminwo_fulus" && $_SESSION["level_user"] != "ts" ){ ?>
						<a class="collapse-item" href="../view/instalasi.php">Instalasi</a> 
						
						<a class="collapse-item" href="../view/odp.php">Instalasi ODP</a>
						
						<a class="collapse-item" href="../view/distribusi.php">Instalasi Distribusi</a>
						
		<?php } ?>	
						
		<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "adminwo_fulus" ){ ?>
						
                        <a class="collapse-item" href="../view/ikr_kapten.php">Instalasi Kapten</a>

						<a class="collapse-item" href="../view/view_kapten_correctiv.php">Instalasi Pararel Modem</a>
						
						<a class="collapse-item" href="../view/distribusi.php">Instalasi Kabel Distribusi</a>

						<a class="collapse-item" href="../view/odp.php">Instalasi ODP</a>
		
						<a class="collapse-item" href="../view/odp_edit.php">Edit Data ODP</a>
						
						<a class="collapse-item" href="../view/ikr_sinden.php">Instalasi Sinden</a>
						
						<a class="collapse-item" href="../view/ikr_omahwifi.php">Instalasi Omah Wifi</a>
						
						<a class="collapse-item" href="../view/ikr_dedicated.php">Instalasi Dedicated</a>
						
						<a class="collapse-item" href="../view/ikr_broadband.php">Instalasi Broadband</a>
             ...
             <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../view/maintenance.php">Maintenance</a>
					<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "adminwo_fulus" && $_SESSION["level_user"] != "ts" ){ ?>	
						<a class="collapse-item" href="../view/maintenanceodp.php">Maintenance ODP</a>   
					<?php } ?>
...
<?php if ( $_SESSION["level_user"] != "adminwo_fulus" && $_SESSION["level_user"] != "ikr" ){?>
						
			<li class="nav-item">

                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pelanggandisable"

                    aria-expanded="true" aria-controls="pelanggandisable">
                ...
                <div id="pelanggandisable" class="collapse" aria-labelledby="headingUtilities"
		...
		<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "adminwo_fulus" ){ ?>
						...
						<a class="collapse-item" href="../view/view_wo_disable_byrequest.php">DCP By Request</a>
						
						<a class="collapse-item" href="../view/view_wo_disable_100day.php">Pelanggan Tidak Ada Kejelasan</a>
		
		<?php } ?>
		
		<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "psg_dcp" && $_SESSION["level_user"] != "adminwo_fulus" ){ ?>
						
						<a class="collapse-item" href="../view/view_wo_disable_berhenti.php">Pelanggan Berhenti</a>
...
<?php  if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "adminwo_fulus" && $_SESSION["level_user"] != "ts" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "super" ){ ?>
                <a class="nav-link" href="../view/dismantle.php">

                    <i class="fas fa-fw fa-wrench"></i>

                    <span>DISMANTLE</span></a>
<?php }   ?>
	...
	<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "psg_dcp" && $_SESSION["level_user"] != "adminwo_fulus" ){ ?>		
			<li class="nav-item active"> 
				<a class="nav-link" href="../view/report_nmc.php">
                    ...
                    <span>REPORT NMC</span></a> 
				
			
            </li>
			
			<li class="nav-item active"> 
				<a class="nav-link" href="../view/report_lain-lain.php">
...
<?php if ( $_SESSION["level_user"] != "adminwo_fulus"  ){ ?>			
			<li class="nav-item">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities1"
                    ...
                    <span>View Jenis Pembayaran:</span>
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <h6 class="collapse-header">Malang</h6>

                        <a class="collapse-item" href="../view/keuangan_mlg_read_ver.php">Malang</a>

                        <a class="collapse-item" href="../view/keuangan_pas_read_ver.php">Pasuruan</a>                        
...
<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "ts" && $_SESSION["level_user"] != "psg_dcp" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "super" ){ ?>
		<?php if ( $_SESSION["level_kantor"] != "pas" && $_SESSION["level_kantor"] != "batu" ){  ?>		
			<li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                    ...
                    <span>VIEW PEMBAYARAN MALANG</span>
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <h6 class="collapse-header">IKR: </h6>
...
<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "ts" && $_SESSION["level_user"] != "psg_dcp" && $_SESSION["level_user"] != "super" ){ ?>
<?php if ( $_SESSION["level_kantor"] != "mlg" && $_SESSION["level_kantor"] != "batu" ){  ?>				
			<li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePas"

                    aria-expanded="true" aria-controls="collapsePas">

                    <i class="fas fa-shopping-cart"></i>

                    <span>VIEW PEMBAYARAN PASURUAN</span>

                </a>
				

				
                <div id="collapsePas" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../view/view_ikr_keuangan_pas_notverified.php">Not Verified</a>

                        <a class="collapse-item" href="../view/view_ikr_keuangan_pas_verified.php">Verified</a>                        
				...
				<div id="collapsePas" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../view/view_ikrcorrectiv_keuanganpas_notverified.php">Not Verified </a>
						<a class="collapse-item" href="../view/view_ikrcorrectiv_keuanganpas_verified.php">Verified </a> 
...
<?php if ( $_SESSION["level_user"] != "Admin" && $_SESSION["level_user"] != "ikr" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "kapten" && $_SESSION["level_user"] != "ts" && $_SESSION["level_user"] != "psg_dcp" && $_SESSION["level_user"] != "super" ){ ?>
<?php if ( $_SESSION["level_kantor"] != "mlg" && $_SESSION["level_kantor"] != "pas" ){  ?>				
			<li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePas"
                    ...
                    <span>VIEW PEMBAYARAN BATU</span>
                ...
                <div id="collapsePas" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../view/view_ikr_keuangan_batu_notverified.php">Not Verified</a>

                        <a class="collapse-item" href="../view/view_ikr_keuangan_batu_verified.php">Verified</a>                        
				...
				<div id="collapsePas" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../view/view_ikrcorrectiv_keuanganbatu_notverified.php">Not Verified </a>
						<a class="collapse-item" href="../view/view_ikrcorrectiv_keuanganbatu_verified.php">Verified </a> 
...
<?php if ( $_SESSION["level_user"] != "psg_dcp" && $_SESSION["level_user"] != "adminwo_fulus"  ){ ?>
			<li class="nav-item">
                ...
                <div class="container-fluid">
                    ...
                    <?php 
                       ...
                       ?>
						...
						<h1 class="h3 mb-0 text-gray-800">Kapten Naratel <?php //echo $_SESSION["level_user"]; ?></h1>
                          <thead>
                          <tr>
					  ...
					  <!-- Sinden modal teknisi -->
					  
					  <h1 class="h3 mb-0 text-gray-800">INSTALASI CORPORATE <?php //echo $_SESSION["level_user"]; ?></h1>
...
ORDER BY key_fal DESC");
					  ...
					  <h1 class="h3 mb-0 text-gray-800">Sinden <?php //echo $_SESSION["level_user"]; ?></h1>
					  ...
					  <div class="table-responsive">
						...
						$acces_user_log = $_SESSION["username"];
						  ...
						  WHERE status_wo='Belum Terpasang' and produk='Sinden'and jenis_wo='INSTALASI_SINDEN' and pic_ikr='".$acces_user_log."' 
						  ORDER BY key_fal DESC");
						  while ($row = mysqli_fetch_assoc($table)){ 
						  $i=0;
						  $no=1;
					  ...
					  <!-- omah wifi modal teknisi -->
					  
					  <h1 class="h3 mb-0 text-gray-800">Omah Wifi <?php //echo $_SESSION["level_user"]; ?></h1>
					  ...
					  <div class="table-responsive">
						...
						$acces_user_log = $_SESSION["username"];
						  $table = mysqli_query($koneksi,"SELECT * FROM tbl_fal 
						  WHERE status_wo='Belum Terpasang' and produk='Omah Wifi'and jenis_wo='INSTALASI_OMAH_WIFI' and pic_ikr='".$acces_user_log."' 
						  ORDER BY key_fal DESC");
						  while ($row = mysqli_fetch_assoc($table)){ 
						  $i=0;
						  $no=1;
						  ...
						  <tr id=<?php echo $row['username_fal']; ?>">
							<td> <?php echo $no; ?></td>
							<td> <?php echo $row['nama_fal'];?></td>
							<td> <?php echo $row['alamat_fal'];?></td>
							<td> <?php echo $row['tlp_fal'];?></td>
							<td> <?php echo $row['paket_fal'];?></td>
							<td> <?php echo $row['tanggal_instalasi'];?></td>
							<td> <?php echo $row['username_fal'];?></td>
							<!-- td data-target="password_fal"> <?php echo $row['password_fal'];?></td>
							<td data-target="lain_lain"> <?php echo $row['lain_lain'];?></td>
							<td data-target="jenis_wo"> <?php echo $row['jenis_wo'];?></td>
							<td data-target="pic_ikr"> <?php echo $row['pic_ikr'];?></td>
							...
							nama_fal="<?php echo $row['nama_fal'];?>"							
							username_fal="<?php echo $row['username_fal'];?>"
							class="btn btn-info btn-sm mr-2 editomahwifi">Edit</button>
					  ...
					  <h1 class="h3 mb-0 text-gray-800">Dedicated <?php //echo $_SESSION["level_user"]; ?></h1>
					  ...
					  <div class="table-responsive">
						...
						$acces_user_log = $_SESSION["username"];
						  $table = mysqli_query($koneksi,"SELECT * FROM tbl_fal 
						  WHERE status_wo='Belum Terpasang' and produk='Dedicated' and jenis_wo='INSTALASI_DEDICATED' and pic_ikr='".$acces_user_log."' 
						  ORDER BY key_fal DESC");
						  while ($row = mysqli_fetch_assoc($table)){ 
						  $i=0;
						  $no=1;
						  ...
						  <tr id=<?php echo $row['username_fal']; ?>">
							...
							nama_fal="<?php echo $row['nama_fal'];?>"							
							username_fal="<?php echo $row['username_fal'];?>"
							class="btn btn-info btn-sm mr-2 editdedicated">Edit</button>
					  ...
					  <h1 class="h3 mb-0 text-gray-800">Broadband <?php //echo $_SESSION["level_user"]; ?></h1>
					  ...
					  <div class="table-responsive">
						...
						$acces_user_log = $_SESSION["username"];
						  $table = mysqli_query($koneksi,"SELECT * FROM tbl_fal 
						  WHERE status_wo='Belum Terpasang' and produk='Broadband' and jenis_wo='INSTALASI_BROADBAND' and pic_ikr='".$acces_user_log."' 
						  ORDER BY key_fal DESC");
						  while ($row = mysqli_fetch_assoc($table)){ 
						  $i=0;
						  $no=1;
						  ...
						  <tr id=<?php echo $row['username_fal']; ?>">
							...
							nama_fal="<?php echo $row['nama_fal'];?>"							
							username_fal="<?php echo $row['username_fal'];?>"
							class="btn btn-info btn-sm mr-2 editbroadband">Edit</button>
            ...
            <div class="modal-content">
                 ...
                 <div class="modal-body">
					...
					<option> <?php
                        ...
                        <div class="form-group col-md-4">
                    <label for="rang">Modem</label>                
                    <select class="form-control" type="text" id="modem_sinden" name="modem_sinden" autocomplete="off" >
                    <option>-</option>
                    <option>ZTE F609 versi 1</option>
                    <option>ZTE F609 versi 2</option>
                    <option>ZTE F609 versi 3</option>
				 ...
				 <div class="form-group col-md-4">
                    <label for="rang">Jenis Pembayaran</label>                
                    <select class="form-control" type="text" id="pembayaran_sinden" name="pembayaran_sinden" autocomplete="off" >
                    <option>-</option>
                    <option>Tunai</option>
                    <option>Transfer</option>				
                    </select>
		...
		$(document).on('click', '.save_corporate', function(){
			//var nama_fal = $("#nama_fal").val();
			 ...
			 var value = { nama_corporate:nama_corporate2,
						   ...
						   pic_corporate:pic_corporate, 
						   pic_corporate2:pic_corporate2, 
