            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Survey Lokasi</h1>
                        <?php 
                ...
                <div class="modal-body">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                                <label for="fname">tgl Survey</label>
	...
	<script>
		 $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    "url":"../models/datapengguna_survey.php",
                    "type":"POST",
                },
                "paging": true,
                "lengthChange": true,
            ...
            $(document).on('click', '.editpengguna', function(){
                var id = $(this).attr("id");
                $.ajax({
                    url:"../controller/get_data_survey.php",
                    method:"POST",
                    data:{id:id},
                    dataType:"JSON",
                    success:function(data)
