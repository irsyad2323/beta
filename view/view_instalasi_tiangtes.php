						  ...
						  <div class="card shadow mb-4">
							...
							<div class="card-body">
							  <div class="table-responsive">
								...
								<div class="d-sm-flex align-items-center justify-content-between mb-4">
									<button type="submit" id="set" name="set" class="btn bg-maroon btn-flat margin pull-right">Blasting Info Profile</button>
								</div>
  ...
  <div class="modal-dialog">
	...
	<div class="modal-body">		
	  <div class="box-header with-border">
		...
		<input type="text" name="all_id" id="all_id"/>
		<div class="form-group">
          <label>Info Blasting</label>
           <textarea class="form-control" id="info_blasting" rows="3" placeholder="Enter ..."></textarea>
        </div>				
