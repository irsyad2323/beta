            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">View Jenis Pembayaran Verified </br> <?php echo $acces_user_log; ?> </br> <?php echo $kota; ?></h1>
			...
			<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Verified</h6>
							</div>
							<div class="card-body">
         ...
         $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"../models/datapengguna_ikr_keuangan_verified.php",
