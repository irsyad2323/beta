        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Data Libur</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="tabel_pengguna" >
                   <thead class="thead-dark">
					<tr>									  
						...
						<th>Tanggal Pengambilan Modem</th>	
						<th>Off</th>
						<th>Range Freeradius</th>    
						<th>Status</th> 							
						<th>Kategori</th> 
						<th>ACTION</th>
					</tr>
                 ...
                 <div class="modal-body">
					...
					<!-- FORM ISIAN DATA ADMIN -->
						...
						<br/>
                            ...
                            <div class="form-row">
                                <label for="rang">Status Modem</label>                
                    ...
                    <option> <?php
											  ...
											  $sql_user = mysqli_query($conn, "SELECT * FROM tbl_pegawai WHERE status_pegawai='aktiv' and status_karyawan in ('PKL','Outsourcing');");
						...
						<hr>
                            <button type="button" class="btn btn-success  pull-right actioneditdcp">Edit</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                 ...
                 <div class="modal-body">
					...
					<option>Modem Diambil</option>
					<option>Orang tidak ada + modem tidak ada</option>
					<option>Orang ada + modem tidak ada</option>
                    <option>orang ada + janji bayar</option>
                    <option>orang tidak ada + modem ada</option>    
                    </select>
                  </div>
    ...
    <script>
         ...
         $(document).ready(function() {
			 //get data value kapten
					...
					// Edit 			
		$(document).on('click', '.actioneditdcp', function(){
			...
			if(lain_lain2 == '' ){
			 ...
			 var value = { 
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_edit_dcp.php",
                    data: value,
                    success : function(data) {
					alert(data);
					Swal.fire(
         ...
         $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"../models/datapengguna_disable_byrequest.php",
