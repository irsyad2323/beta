            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Instalasi Pararel Modem<?php //echo $_SESSION["level_user"]; ?></h1>
                        <?php 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-2">
                            ...
                            <input class="form-control" type="text" id="username_Maintenance" name="username_Maintenance" placeholder="id..." autocomplete="off">
                        </div>                 
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                         <div class="form-group col-md-2">
                                <label for="fname">tgl Maintenance</label>
                                <input class="form-control" type="text" id="username_fal" name="username_fal" placeholder="tidak usah di isi" autocomplete="off" disabled>
                            </div>
    ...
    <div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
			...
			<form role="form" method="post" id='formdatapengguna'>
                            <div class="form-row">
								<label for="rang">ID USER</label>   
								<select class='js-example-basic-multiple' id="kode_user" name="kode_user" multiple="multiple" style='width: 350px;'>								
								 </select>
						</div><br/>
                           ...
                           <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <label for="fname">Nama</label>
                                <input class="form-control" type="text" id="nama_fal" name="nama_fal" placeholder="nama..." autocomplete="off" readonly>
                            </div>                                             
                           
                            <div class="form-group col-md-2">
                                <label for="halaman">Alamat</label>
                                <input class="form-control" type="number" id="tlp_fal" name="tlp_fal" placeholder="telepon.." autocomplete="off" readonly>
                            </div>                                              
                            ...
                            <div class="form-group col-md-2">
                               <label for="rang">kantor Cabang</label>                
								<select class="form-control" type="text" id="kd_layanan" name="kd_layanan" autocomplete="off" readonly>
                    ...
                    <option>dedy</option>                                                    
                            ...
                            <div class="form-group col-md-6">
                            <label for="lname">Alamat</label>
                            <input class="form-control" type="text" id="alamat_fal" name="alamat" placeholder="alamat..." autocomplete="off" readonly>
                        </div>                           
                          
                            <div class="form-group col-md-2">
                                <label for="rang">Kelurahan</label>
                               <input class="form-control" type="text" id="kelurahan" name="kelurahan" placeholder="kelurahan..." autocomplete="off" readonly>
                            </div>                                      
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <option>Bayu#Outsourcing</option>
                    <option>Ucup#Outsourcing</option>                                                   
                    <option>Vian#Outsourcing</option>                                                   
                    </select>
                  </div>
                    ...
                    <option>Bayu#Outsourcing</option>
                    <option>Ucup#Outsourcing</option>                                                 
                    <option>Dedy#Outsourcing</option>                                                 
                    </select>
                  </div>          
			...
			<form role="form" method="post" id='formdatapengguna'>
                           ...
                           <div class="form-row">
                            <div class="form-group col-md-2" >
                                <label for="fname">Nama</label>
                                <input class="form-control" type="text" id="nama_fal" name="nama_fal" placeholder="nama..." autocomplete="off" disabled>
                            </div>                                             
                           
                            <div class="form-group col-md-2">
                                <label for="halaman">NO. Telepon</label>
                                <input class="form-control" type="text" id="tlp_fal" name="tlp_fal" placeholder="telepon.." autocomplete="off" disabled>
                            </div>  
                    ...
                    <div class="form-group col-md-2" >
                            <label for="rang">ID User</label>
                            <input class="form-control" type="text" id="username_Maintenance" name="username_Maintenance" placeholder="id..." autocomplete="off" disabled>
                        </div>                 
				  ...
				  <div class="form-group col-md-2">
                     ...
                     <select class="form-control" type="text" id="total_modem" name="total_modem" autocomplete="off">
                    <option></option>
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
	...
	<script>
		 $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    "url":"../models/datapengguna_instalasi_correctiv.php",
                    "type":"POST",
                },
                "paging": true,
                "lengthChange": true,
            ...
            var tgl_fal = $("#tgl_fal").val();            
            var username_fal = $("#kode_user").val();
            ...
            $(document).on('click', '.editpengguna', function(){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
						...
						$("#total_modem").val(data.total_modem);
