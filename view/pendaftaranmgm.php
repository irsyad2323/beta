...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">FAL PENDAFTARAN MGM <?php //echo $_SESSION["level_user"]; ?></h1>
						...
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Data Pendaftaran MGM</h6>
							</div>
							<div class="card-body">
								  ...
								  <tbody> 
									<?php 
										  ...
										  <tr id=<?php echo $row['key_fal']; ?>">
											...
											<td>
												<div class="dropdown">
												  ...
												  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													<a href="https://pendaftaran.kaptennaratel.com/mgm/Foto_KTP/<?php echo $row['foto_ktp'];?>" target="_blank" class="dropdown-item">
												 Foto KTP</a>
												    <a href="https://pendaftaran.kaptennaratel.com/mgm/Foto_Rumah/<?php echo $row['foto_rumah'];?>" target="_blank" class="dropdown-item">
												 Foto Rumah</a>
											...
											class="dropdown-item edit_penmgm_old">Post WO</button>
													<button type="button" name="edit" data-id="<?php echo $row['key_fal'];?>"
											key_fal="<?php echo $row['key_fal'];?>"							
	...
	<div class="modal fade" id="modaltambahdata"  role="dialog" tabindex="-1" aria-labelledby="exampleModalLongTitle" aria-text="true">
                ...
                <div class="modal-header">
                 ...
                 <div class="modal-body">
					...
					<?php 
                     ...
                     <select class='form-control' id="OLT" name="OLT" >
						...
						<br/>
							...
							<div class="form-row">
                               <input class="form-control" type="text" id="key_fal" name="key_fal" placeholder="rt..." autocomplete="off" >
                            </div>
                            ...
                            <div class="form-row">
                               <input class="form-control" type="text" id="kelurahan" name="kelurahan" placeholder="" autocomplete="off" >
                            </div>
					
						
                            <div class="form-row">
                               <input class="form-control" type="text" id="kecamatan" name="kecamatan" placeholder="" autocomplete="off" >
                            </div>
						
                            <div class="form-row">
                               <input class="form-control" type="text" id="kabupaten" name="kabupaten" placeholder="" autocomplete="off" >
                            </div>
						
                            <div class="form-row">                               
                               <input class="form-control" type="text" id="provinsi" name="provinsi" placeholder="" autocomplete="off" >
                            </div>
						
						<div class="form-row">                               
                               <input class="form-control" type="text" id="lokasi" name="lokasi" placeholder="" autocomplete="off" >
                            </div>
						
                        
						<div class="form-row">                               
                               <input class="form-control" type="text" id="foto_rumah" name="foto_rumah" placeholder="" autocomplete="off" >
                            </div>
							
							<div class="form-row">                               
                               <input class="form-control" type="text" id="status_lokasi" name="status_lokasi" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="tahu_layanan" name="tahu_layanan" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="alasan" name="alasan" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="foto_ktp" name="foto_ktp" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="no_wa2" name="no_wa2" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="no_wa3" name="no_wa3" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="no_wa4" name="no_wa4" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="nama_sobat" name="nama_sobat" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="metode_pembayaran" name="metode_pembayaran" placeholder="" autocomplete="off" >
                            </div>
						
							<div class="form-row">                               
                               <input class="form-control" type="text" id="no_rekening" name="no_rekening" placeholder="" autocomplete="off" >
                            </div>
					...
					<br/>
						...
						<hr>
                            <button type="button" class="btn btn-success  pull-right action_post_kap_mgm">Insert</button>
	...
	<div class="modal fade" id="modaledit"  role="dialog" tabindex="-1" aria-labelledby="exampleModalLongTitle" aria-text="true">
                       ...
                       ?>
						...
						<br/>	
                            ...
                            <div class="form-row">
                               ...
                               <input class="form-control" type="text" id="kelurahan2" name="kelurahan2" placeholder="" autocomplete="off" >
                            </div>
						<br/>
    ...
    <div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-text="true">
...
/* $(document).ready(function() {
    ...
    <script>
         ...
         $(document).ready(function() {
			...
			// INSERT 			
		$(document).on('click', '.action_post_kap_mgm', function(){
		...
		$(document).on('click', '.edit_penmgm_old', function(){
                //alert($(this).data('id'));
