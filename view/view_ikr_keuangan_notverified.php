...
<body id="page-top">
	...
	<?php include '../sidebar.php'; ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Storan Unit</h6>
							</div>
							<div class="card-body">
			...
			<div class="container-fluid">					
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">Storan Unit Berbeda</h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
								<table class="table table-bordered" id="tabel_pengguna_storanlain" width="100%" cellspacing="0">
								  <thead>
									<tr>
									<th>NO</th>
									<th>Tanggal Instalasi</th>
	...
	<!-- modal -->
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form>
							...
							<div class="col-sm-6">
                                <label for="recipient-name" class="col-form-label">Storan Unit</label>
                                <select name="setoran" id='setoran' class="form-control">
								   <option value=""></option>					
				...
				<div class="modal fade bd-example-modal-lg" id="modal_update_read" tabindex="-1" role="dialog" aria-labelledby="modal_update_read" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_update_read">Form Verifikasi Keuangan Marketing</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="key_fal_read" id='key_fal_read' placeholder="" />
                        </div> 
                        <div class="row">
                            <div class="col-md-4">
                                <label for="recipient-name" class="col-form-label">USERNAME</label>
                                <input type="text" class="form-control" name="username_fal_read" id='username_fal_read' placeholder="" readonly>
                            </div>

                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">TANGGAL INSTALASI</label>
                                <input type="date" class="form-control" name="tanggal_instalasi_read" id='tanggal_instalasi_read' placeholder="" readonly>
                            </div>  

                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">PIC</label>
                                <input type="text" class="form-control" name="pic_read" id='pic_read' placeholder="" readonly>
                            </div>

                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">PIC2</label>
                                <input type="text" class="form-control" name="pic2_read" id='pic2_read' placeholder="" readonly>
                            </div>

                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">TOTAL</label>
                                <input type="text" class="form-control" name="total_read" id='total_read' placeholder="" readonly>
                            </div>

                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">LOG USER</label>
                                <input type="text" class="form-control" name="log_user_verified_read" id='log_user_verified_read' placeholder="" readonly>
                            </div>

                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">TANGGAL VERIFIED</label>
                                <input type="text" class="form-control" name="tgl_verified_read" id='tgl_verified_read' placeholder="" readonly>
                            </div>
                        </div>
                        <br/><hr/>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="recipient-name" class="col-form-label">PERLAKUAN</label>
                                <select name="perlakuan_read" id='perlakuan_read' class="form-control">
                                    <option value=""></option>
                                    <option value="Diskon Biaya Instalasi">Diskon Biaya Instalasi</option>
                                    <option value="Angsuran Biaya Instalasi">Angsuran Biaya Instalasi</option>
                                    <option value="Pindah Alamat">Pindah Alamat</option>
                            ...
                            <div class="col-sm-6">
                                <label for="recipient-name" class="col-form-label">TOTAL DISKON</label>
                                <input type="text" class="form-control" name="total_diskon_read" id='total_diskon_read' placeholder="">
                            </div>

                            <div class="col-sm-6">
                                <label for="recipient-name" class="col-form-label">PAKET FAL</label>
                                <select name="paket_fal_read" id='paket_fal_read' class="form-control">
                                    <option value="5">5</option>
                                    <option value="10">10</option>
                                    <option value="15">15</option>
                                    <option value="20">20</option>
                            ...
                            <div class="col-sm-6">
                                <label for="recipient-name" class="col-form-label">JENIS BAYAR</label>
                                <select name="pembayaran_read" id='pembayaran_read' class="form-control">
                                    <option value="Tunai">Tunai</option>
                                    <option value="Transfer">Transfer</option>
                                    <option value="Mitra Bayar">Mitra Bayar</option>
                                </select>
                            ...
                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">ANGSURAN 1</label>
                                <input type="number" class="form-control" name="angsuran1_read" id='angsuran1_read' placeholder="" >
                                <input type="date" class="form-control" name="verif1_read" id='verif1_read' placeholder="" >
                            </div>

                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">ANGSURAN 2</label>
                                <input type="number" class="form-control" name="angsuran2_read" id='angsuran2_read' placeholder="">
                                <input type="date" class="form-control" name="verif2_read" id='verif2_read' placeholder="">
                            </div>

                            <div class="col-sm-4">
                                <label for="recipient-name" class="col-form-label">STATUS ANGSURAN</label>
                                <select name="status_angsuran_read" id='status_angsuran_read' class="form-control">
                                    <option value=""></option>
                                    <option value="Sudah Lunas">Sudah Lunas</option>
                                    <option value="Belum Lunas">Belum Lunas</option>
                                </select>
                            ...
                            <div class="col-sm-12">
                                <label for="recipient-name" class="col-form-label">KETERANGAN</label>
                                <input type="longtext" class="form-control" name="keterangan_read" id='keterangan_read' placeholder="">
                            </div>
                        </div>
                        </br><hr/>
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="recipient-name" class="col-form-label">Verified</label>
                                <select name="verified1_read" id='verified1_read' class="form-control">
                                    <option value=""></option>
                                    <option value="verified">verified</option>
                                    <option value="not_verified">not_verified</option>
                                </select>
	...
	//get data value sinden
    $(document).on('click', '.edit_data_read', function(){        
        var key_fal = $(this).attr('key_fal');
        var username_fal = $(this).attr('username_fal');
        var tanggal_instalasi = $(this).attr('tanggal_instalasi');
        var paket_fal = $(this).attr('paket_fal');
       ...
       $('#modal_update_read').modal('show');
		$('#key_fal_read').val(key_fal);
		$('#username_fal_read').val(username_fal);
		$('#tanggal_instalasi_read').val(tanggal_instalasi);
		$('#paket_fal_read').val(paket_fal);
		$('#pic_read').val(pic);
		$('#pic2_read').val(pic2);
		$('#pembayaran_read').val(pembayaran);
		$('#perlakuan_read').val(perlakuan);
		$('#total_diskon_read').val(total_diskon);
		$('#angsuran1_read').val(angsuran1);
		$('#angsuran2_read').val(angsuran2);
		$('#verif1_read').val(verif1);
		$('#verif2_read').val(verif2);
		$('#total_read').val(total);
		$('#log_user_verified_read').val(log_user_verified);
		$('#tgl_verified_read').val(tgl_verified);
		$('#type_verified_read').val(type_verified);
		$('#status_angsuran_read').val(status_angsuran);
		$('#verified1_read').val(verified);
	...
	var table = $('#tabel_pengguna_storanlain').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"../models/datapengguna_ikr_keuangan_stroanunitlain.php",
