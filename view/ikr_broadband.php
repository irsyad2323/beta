            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">IKR Broadband <?php //echo $_SESSION["level_user"]; ?></h1>
                        <?php 
                    ...
                    <form action="" id="formdatapengguna">
                        <div class="form-row">
							...
							<div class="form-group col-md-2">
                                <label for="rang">KODE Broadband</label>                
                     <select class='form-control' id="OLT" name="OLT" >
					    <option></option>						
						<option value="BR">Broadband</option>						
	...
	<script>
         $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    "url":"../models/datapengguna_broadband.php",
                    "type":"POST",
                },
                "paging": true,
                "lengthChange": true,
            ...
            var value = { action:action, nama_fal:nama_fal, kd_layanan:kd_layanan, pic_ikr:pic_ikr,alamat_fal:alamat_fal, rt:rt,rw:rw,kelurahan:kelurahan,tlp_fal:tlp_fal, pic:pic , status:status, status2:status2, jenis_wo:jenis_wo,produk:produk,modem:modem,kabel1:kabel1,kabel2:kabel2,kabel3:kabel3,paket_fal:paket_fal, tgl_fal:tgl_fal, username_fal:username_fal, username_Maintenance:username_Maintenance, password_fal:password_fal, status_wo:status_wo,lain_lain:lain_lain, ket:k }; 
                ...
                $.ajax({
                    type: "POST",
                    url: "../controller/action_broadband.php",
                    data: value,
            ...
            $(document).on('click', '.editpengguna', function(){
                var id = $(this).attr("id");
                $.ajax({
                    url:"controller/get_data_broadband.php",
                    method:"POST",
                    data:{id:id},
                    dataType:"JSON",
                    success:function(data)
