            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">MAINTENANCE BACKBONE<?php //echo $_SESSION["level_user"]; ?></h1>
                        <?php 
...
?></div>
		...
		<!-- Begin Page Content -->
						<div class="container-fluid">
						  ...
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">DATA MAINTENANCE BACKBONE BELUM TERPASANG</h6>
							</div>
							<div class="card-body">
					...
					<!-- DataTales Example -->
						  <div class="card shadow mb-4">
							<div class="card-header py-3">
							  <h6 class="m-0 font-weight-bold text-primary">DATA MAINTENANCE SUDAH TERPASANG</h6>
							</div>
							<div class="card-body">
							  <div class="table-responsive">
			...
			<form role="form" method="post" id='formdatapengguna'>
                           ...
                           <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input class="form-control" type="text" id="nama_backbone" name="nama_backbone" placeholder="nama..." autocomplete="off">
                            </div>                                             
                           
						   <div class="form-group col-md-2">
								<label for="rang">Jenis Produk</label>                
								<select class="form-control" type="text" id="produk_backbone" name="produk_backbone" autocomplete="off">
								<option>-</option>
                    ...
                    <select class="form-control" type="text" id="kd_layanan_backbone" name="kd_layanan_backbone" autocomplete="off" required>
                   ...
                   <select class="form-control" type="text" id="pic_ikr_backbone" name="pic_ikr_backbone" autocomplete="off">
					<option>-</option>
                            ...
                            <input class="form-control" type="text" id="alamat_fal_backbone" name="alamat_backbone" placeholder="alamat..." autocomplete="off">
                        </div>                                     		
                   ...
                   <div class="form-group col-md-6">
                        ...
                        <hr>
                            <button type="button" class="btn btn-success  pull-right saveinsert_backbone">Insert</button>
                            <button type="reset" class="btn btn-danger pull-right"><i class="fa fa-times fa-fw"></i>Reset</button>
                        </form>
	...
	<script>
		 $(document).ready(function() {
            ...
            var table = $('#tabel_pengguna').DataTable({
                ...
                "ajax": {
                    "url":"../models/datapenggunamaintenancebackbone.php",
                    "type":"POST",
                },
                "paging": true,
                "lengthChange": true,
                ...
                "columns": [
                    { mData: 'no'},
                    { mData: 'nama_backbone'} ,
                    { mData: 'lain_lain_backbone'} ,
                    { mData: 'produk_backbone'} ,
                    { mData: 'alamat_fal_backbone'} ,                   
                    { mData: 'kd_layanan_backbone'} ,
                    { mData: 'pic_ikr_backbone'} ,
                    { mData: 'type_status'} ,
                    { mData: 'action'},                    
                ],
            });
             ...
             var table = $('#tabel_solved').DataTable({
                ...
                "ajax": {
                    ...
                    "url":"../models/datapengguna_maintenance_ts_backbone.php",
		...
		$(document).on('click', '.saveupdate9', function(){
			...
			// create 			
		$(document).on('click', '.saveinsert_backbone', function(){
			//var nama_fal = $("#nama_fal").val();
			 var nama_backbone = $('#nama_backbone').val();
			 var produk_backbone = $('#produk_backbone').val();
			 var kd_layanan_backbone = $('#kd_layanan_backbone').val();
			 var pic_ikr_backbone = $('#pic_ikr_backbone').val();
			 var alamat_fal_backbone = $("#alamat_fal_backbone").val();
			 var lain_lain_backbone = $("#lain_lain_backbone").val();
		 
			 var value = { nama_backbone:nama_backbone,
						   produk_backbone:produk_backbone,
						   kd_layanan_backbone:kd_layanan_backbone, 
						   pic_ikr_backbone:pic_ikr_backbone,
						   alamat_fal_backbone:alamat_fal_backbone,
                ...
                $.ajax({
                    ...
                    type: "POST",
					async: false,
                    url: "../controller/action_insert_backbone.php",
                    data: value,
                    success : function(data) {
					alert(data);
					window.location.reload(true);
