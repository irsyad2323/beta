								  ...
								  <tbody> 
									<?php 
										  ...
										  $table = mysqli_query($koneksi,"SELECT key_fal,rt,rw,provinsi,kabupaten,kecamatan,kelurahan, status_lokasi,nama_sobat,metode_pembayaran,no_rekening,an_rek,wa_sobat,mgm,paket_kapten,nama_lengkap,alamat,no_wa,no_wa2,no_wa3,no_wa4,patokan,foto_ktp,foto_rumah, tahu_layanan,
											...
											WHERE a.status='n' and a.stts_ver='n' and a.kabupaten = d.kd_kabkota AND d.kd_kec = e.kd_kec 
											and c.kd_kabkota = e.kd_kabkota and a.layanan in ('mlg','mlg1','batu','pas') GROUP BY a.key_fal DESC 
												...
												<div class="dropdown">
												  ...
												  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												    ...
												    <a href="https://pendaftaran.kaptennaratel.com/Foto_Rumah/<?php echo $row['foto_rumah'];?>" target="_blank" class="dropdown-item">
														Foto Rumah</a>
												    <a href="https://wa.me/<?php echo $row['no_wa'];?>" target="_blank" class="dropdown-item">
														Whatsapp</a>
												    <a href="<?php echo $row['lokasi'];?>" target="_blank" class="dropdown-item">
														Maps</a>
												    <button type="button" name="edit" key_fal="<?php echo $row['key_fal'];?>"
														...
														class="dropdown-item ver_pen">Verified Pendaftaran</button>
                     ...
                     <select class='form-control' id="OLT" name="OLT" >
						...
						<br/>
							...
							<div class="form-row">
								...
								<input class="form-control" type="text" id="username_fal" name="username_fal" autocomplete="off" readonly>
							</div>
						<br/>
                            <div class="form-row">
       ...
       $(document).on('click', '.ver_pen', function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    xhr.send("key_fal=" + key_fal + "&mgm=" + mgm);
                }
				});
