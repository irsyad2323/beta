                    ...
                    <?php 
                       ...
                       ?>
						...
						$acces_user_log = $_SESSION["username"];
						  $table = mysqli_query($koneksi,"SELECT * FROM tbl_disable_noconfirm WHERE kd_layanan like '".$kota."' and kategori_pelanggan='Modem Diambil' ORDER BY key_fal DESC");
						  ...
						  <tr id=<?php echo $row['username_fal']; ?>">
							...
							<td data-target="status_log"> <?php echo $row['status_log'];?></td>
    ...
    <script>
		...
		$(document).on('click', '.editberhentiadd', function(){
			//var nama_fal = $("#nama_fal").val();
			 ...
			 var value = { nama_berhenti:nama_berhenti,
