...
$query = "SELECT key_fal, permit_status_id, pic, status, metode_followup, jangka_waktu_komitmen, total_komitmen, deskripsi_komitmen, termin_pembayaran, keterangan, dokumentasi, berita_acara, created_at FROM business_solutions_status WHERE key_fal = :key_fal ORDER BY created_at DESC";
