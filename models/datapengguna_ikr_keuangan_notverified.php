...
if ($level_user == "adminwo_fulus") {
		$query = "SELECT (a.hrg_ins + a.hrg_pkt) - a.total_diskon - a.angsuran1 - a.angsuran2) as total,a.*,b.harga, CONCAT(angsuran1,'   ',verif1) angsuran_fix1, CONCAT(angsuran2,'   ',verif2) angsuran_fix2
FROM tbl_fal a
INNER JOIN price_harga b
        ON a.paket_fal = b.paket
WHERE kd_layanan like '".$kota."' and status_wo='Sudah Terpasang' and produk='Kapten Naratel' and jenis_wo='INSTALASI' and verified='not_verified'
