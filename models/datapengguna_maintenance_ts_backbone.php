...
$acces_user_log = $_SESSION["username"];
		$query = "SELECT * FROM tbl_maintenance_backbone WHERE tanggal_instalasi = CURDATE() AND status_wo='Sudah Terpasang' and kd_layanan like '".$kota."' ORDER BY key_fal DESC ";
