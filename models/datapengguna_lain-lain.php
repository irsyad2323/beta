...
if ($level_user == "ikr") {
	//$query = "SELECT * FROM tbl_report_nmc WHERE jenis_wo='REPORT_NMC' and pic_ikr='".$acces_user_log."' ORDER BY key_fal DESC ";
	$query = "SELECT * FROM tbl_report_nmc WHERE jenis_wo='REPORT_NMC' ORDER BY key_fal DESC ";
	...
	$query = "SELECT * FROM tbl_report_nmc WHERE  jenis_wo='REPORT_NMC' ORDER BY key_fal DESC";
		...
		$query = "SELECT * FROM tbl_report_nmc WHERE jenis_wo='REPORT_NMC' and tanggal_instalasi = CURDATE() ORDER BY key_fal DESC ";
	}
