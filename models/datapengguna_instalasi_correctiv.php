...
if ($level_user == "ikr") {
	$query = "SELECT * FROM tbl_fal_correctiv WHERE status_wo='Belum Terpasang' and jenis_wo='INSTALASI_CORRECTIV' and pic_ikr='".$acces_user_log."' ORDER BY key_fal DESC ";
	} else if ($level_user == "Admin") {
	$query = "SELECT * FROM tbl_fal_correctiv WHERE  jenis_wo='INSTALASI_CORRECTIV' ORDER BY key_fal DESC";
	} 
	else if ($level_user == "kapten") {
		$query = "SELECT * FROM tbl_fal_correctiv WHERE jenis_wo='INSTALASI_CORRECTIV' and status_wo='Belum Terpasang' ORDER BY key_fal DESC";
	}
	else if ($level_user == "ts") {
		$query = "SELECT * FROM tbl_fal_correctiv WHERE jenis_wo='INSTALASI_CORRECTIV' and tanggal_instalasi = CURDATE() ORDER BY key_fal DESC ";
	}
