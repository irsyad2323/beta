...
$query = "SELECT CONCAT(a.provinsi,'.',a.kabkota,'.',a.kecamatan,'.',a.kelurahan,'.',a.id_tiang) as id , a.* FROM tbl_instalasi_tiang a WHERE a.kd_layanan='$kota' and a.status='Belum Dikerjakan';";
