...
foreach($data as $dataz){
	...
	$data[$i]['action']='<div class="btn-group">	 
							<button type="button" name="edit" id="'.$data[$i]["id"].'" class="btn btn-info btn-sm mr-2 editpengguna">Edit</button>
							<button type="button" name="delete" id="'.$data[$i]["id"].'" class="btn btn-danger btn-sm deletepengguna">delete</button>
						</div>';
	/*
