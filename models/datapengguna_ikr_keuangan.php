...
/* if($pembayaran == 'Tunai'){
	if ($kd_layanane == $layanan_bayare) {
		$data[$i]['actione'] = '<div class="btn-group">
			...
			$data[$i]['actione'] = '<div class="btn-group">
									...
									status_angsuran="' . $data[$i]["status_angsuran"] . '"  
									verified="' . $data[$i]["verified"] . '"  
									class="btn btn-warning btn-sm mr-2 edit_data_read">Read</button>
								</div>';
		}
