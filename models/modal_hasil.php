...
$query = mysqli_query($koneksi," select * from tbl_pengajuan where layanan like 'mlg' ORDER BY date DESC ;");
$data = array();
	...
	$data[$i]['action']='<!-- div class="btn-group">	 
							...
							<div class="dropdown">
							  ...
							  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								...
								<a key_fal="'.$data[$i]["key_fal"].'" name="edit" class="dropdown-item upload_bukti">Upload Bukti</a>
								<a key_fal="'.$data[$i]["key_fal"].'" name="edit" class="dropdown-item approved">Approved</a>
