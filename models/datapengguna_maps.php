...
if ($level_user == "ikr") {
	...
	$query = "SELECT * FROM tbl_fal WHERE produk='Kapten Naratel' and jenis_wo='INSTALASI' ORDER BY key_fal DESC";
	} 
	else if ($level_user == "kapten") {
		$query = "SELECT * FROM tbl_fal WHERE produk='Kapten Naratel' and jenis_wo='INSTALASI' and status_wo='Belum Terpasang' and kd_layanan like '".$kota."' ORDER BY key_fal DESC";
	}
	else if ($level_user == "ts") {
		$query = "SELECT * FROM tbl_fal WHERE produk='Kapten Naratel' and jenis_wo='INSTALASI' and tanggal_instalasi = CURDATE() ORDER BY key_fal DESC ";
	}
	else if ($level_user == "super") {
		$query = "SELECT * FROM tbl_fal WHERE produk='Kapten Naratel' and status_wo='Belum Terpasang' and jenis_wo='INSTALASI' ORDER BY key_fal DESC";
	}
