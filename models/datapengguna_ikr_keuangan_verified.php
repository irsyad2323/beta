...
if ($level_user == "adminwo_fulus") {
		$query = "SELECT (a.hrg_ins + a.hrg_pkt - a.total_diskon) as total,a.*,b.harga, CONCAT(angsuran1,'   ',verif1) angsuran_fix1, CONCAT(angsuran2,'   ',verif2) angsuran_fix2
FROM tbl_fal a
INNER JOIN price_harga b
        ON a.paket_fal = b.paket
WHERE kd_layanan like '".$kota."' and YEAR(tanggal_instalasi) in ('2024','2025') and status_wo='Sudah Terpasang' and produk='Kapten Naratel' and jenis_wo='INSTALASI' and verified='verified'
