...
$query = "SELECT CONCAT(a.provinsi,'.',a.kabkota,'.',a.kecamatan,'.',a.kelurahan,'.',a.id_tiang) as id , a.* FROM tbl_instalasi_tiang a WHERE a.status='Belum Dikerjakan' and a.kd_layanan like '".$kota."';";
