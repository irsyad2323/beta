...
$acces_user_log = $_SESSION["username"];
		...
		$query = "SELECT * FROM tbl_maintenance_patroli WHERE tanggal_instalasi = CURDATE() AND status_wo='y' and kd_layanan like 'mlg' ORDER BY tanggal_instalasi DESC;";
...
foreach($data as $dataz){
	...
	if($data[$i]['status_wo'] == 'y'){
	$data[$i]['type_status'] = '<small class="badge badge-success">Done</small>';
    }					
