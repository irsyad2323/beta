...
if(!empty($_POST["prov_id"])){ 
    ...
    $sql = "SELECT * FROM tb_kabkota WHERE status='y' and kd_provinsi = ".$_POST['prov_id']." ORDER BY nama_kabkota ASC"; 
    ...
    if(true){ 
        ...
        while($row = mysqli_fetch_assoc($query)){  
            echo '<option value="'.$row['kd_kabkota'].'">'.$row['nama_kabkota'].'</option>'; 
        } 
    }else{ 
        echo '<option value="">Kabupaten not available</option>'; 
    } 
} 
